...
var is = function () {
    ...
    ease: as(.25, .1, .25, 1),
    "ease-in": as(.42, 0, 1, 1),
    "ease-out": as(0, 0, .58, 1),
    "ease-in-out": as(.42, 0, .58, 1),
    "ease-in-sine": as(.47, 0, .745, .715),
    "ease-out-sine": as(.39, .575, .565, 1),
    "ease-in-out-sine": as(.445, .05, .55, .95),
    "ease-in-quad": as(.55, .085, .68, .53),
    "ease-out-quad": as(.25, .46, .45, .94),
    "ease-in-out-quad": as(.455, .03, .515, .955),
    "ease-in-cubic": as(.55, .055, .675, .19),
    "ease-out-cubic": as(.215, .61, .355, 1),
    "ease-in-out-cubic": as(.645, .045, .355, 1),
    "ease-in-quart": as(.895, .03, .685, .22),
    "ease-out-quart": as(.165, .84, .44, 1),
    "ease-in-out-quart": as(.77, 0, .175, 1),
    "ease-in-quint": as(.755, .05, .855, .06),
    "ease-out-quint": as(.23, 1, .32, 1),
    "ease-in-out-quint": as(.86, 0, .07, 1),
    "ease-in-expo": as(.95, .05, .795, .035),
    "ease-out-expo": as(.19, 1, .22, 1),
    "ease-in-out-expo": as(1, 0, 0, 1),
    "ease-in-circ": as(.6, .04, .98, .335),
    "ease-out-circ": as(.075, .82, .165, 1),
    "ease-in-out-circ": as(.785, .135, .15, .86),
...
function cs(e, t, n, r) {
    ...
    if (!o.easingImpl) if (null == s) o.easingImpl = os.linear; else {
        var c, d, h;
        if (v(s)) c = u.parse("transition-timing-function", s).value; else c = s;
        v(c) ? (d = c, h = []) : (d = c[1], h = c.slice(2).map((function (e) {
            return +e
        }))), h.length > 0 ? ("spring" === d && h.push(o.duration), o.easingImpl = os[d].apply(null, h)) : o.easingImpl = os[d]
    }
    ...
    if (p = 0 === o.duration ? 1 : (n - l) / o.duration, o.applying && (p = o.progress), p < 0 ? p = 0 : p > 1 && (p = 1), null == o.delay) {
        ...
        if (y && i && !e.locked()) {
            var m = {};
            ds(g.x, y.x) && (m.x = us(g.x, y.x, p, f)), ds(g.y, y.y) && (m.y = us(g.y, y.y, p, f)), e.position(m)
        }
        var b = o.startPan, x = o.pan, w = a.pan, E = null != x && r;
        E && (ds(b.x, x.x) && (w.x = us(b.x, x.x, p, f)), ds(b.y, x.y) && (w.y = us(b.y, x.y, p, f)), e.emit("pan"));
        var k = o.startZoom, C = o.zoom, S = null != C && r;
        S && (ds(k, C) && (a.zoom = Tt(a.minZoom, us(k, C, p, f), a.maxZoom)), e.emit("zoom")), (E || S) && e.emit("viewport");
        var P = o.style;
        if (P && P.length > 0 && i) {
            for (var D = 0; D < P.length; D++) {
                var T = P[D], _ = T.name, M = T, B = o.startStyle[_], N = us(B, M, p, f, u.properties[B.name]);
...
function ps(e, t) {
    ...
    function i(t, n) {
        ...
        for (var u = function (e) {
            ...
            h.stopped ? (a.splice(c, 1), h.hooked = !1, h.playing = !1, h.started = !1, u(h.frames)) : (h.playing || h.applying) && (h.playing && h.applying && (h.applying = !1), h.started || hs(0, d, e), cs(t, d, e, n), h.applying && (h.applying = !1), u(h.frames), null != h.step && h.step(e), d.completed() && (a.splice(c, 1), h.hooked = !1, h.playing = !1, h.started = !1, u(h.completes)), s = !0)
        }
    ...
    startAnimationLoop: function () {
        ...
        if (e._private.animationsRunning = !0, e.styleEnabled()) {
            ...
            t && t.beforeRender ? t.beforeRender((function (t, n) {
                ...
                e._private.animationsRunning && xe((function (n) {
                    ps(n, e), t()
                }))
            }()
        }
...
var bs = {
    layout: function (e) {
        if (null != e) if (null != e.name) {
            ...
            Ve("No such layout `" + t + "` found.  Did you forget to import it and `cytoscape.use()` it?")
        } else Ve("A `name` must be specified to make a layout"); else Ve("Layout options must be specified to make a layout")
    }
};
...
var xs = {
    ...
    renderTo: function (e, t, n, r) {
        ...
        if (null != t) {
            void 0 !== e.wheelSensitivity && je("You have set a custom wheel sensitivity.  This will make your app zoom unnaturally when using mainstream mice.  You should change this value from the default only if you can guarantee that all your users will use the same hardware and OS configuration as your current machine.");
            var n = ws(e);
            n.cy = this, this._private.renderer = new t(n), this.notify("init")
        } else Ve("Can not initialise: No such renderer `".concat(e.name, "` found. Did you forget to import it and `cytoscape.use()` it?"))
...
var ks = {
    collection: function (e, t) {
        return v(e) ? this.$(e) : E(e) ? e.collection() : m(e) ? (t || (t = {}), new ts(this, e, t.unique, t.removed)) : new ts(this)
    }, nodes: function (e) {
...
Cs.apply = function (e) {
    ...
    if (s) {
        var O = t.styleKeys, R = O.nodeBody, V = O.nodeBorder, F = O.nodeOutline, j = O.backgroundImage, q = O.compound,
            Y = O.pie, X = [R, V, F, j, q, Y].filter((function (e) {
                return null != e
            })).reduce(De, [9261, 5381]);
    ...
    var f = function () {
        je("Do not assign mappings to elements without corresponding data (i.e. ele `" + e.id() + "` has no mapping for property `" + i.name + "` with data field `" + i.field + "`); try a `[" + i.field + "]` selector to limit scope to elements with `" + i.field + "` defined")
    };
    switch (i.mapped) {
        case o.mapData:
            ...
            if (!x(y)) return je("Do not use continuous mappers without specifying numeric data (i.e. `" + i.field + ": " + y + "` for `" + e.id() + "` is non-numeric)"), !1;
            var b = i.fieldMax - i.fieldMin;
            if ((g = 0 === b ? 0 : (y - i.fieldMin) / b) < 0 ? g = 0 : g > 1 && (g = 1), s.color) {
                var w = i.valueMin[0], E = i.valueMax[0], k = i.valueMin[1], C = i.valueMax[1], S = i.valueMin[2],
                    P = i.valueMax[2], D = null == i.valueMin[3] ? 1 : i.valueMin[3],
        ...
        case o.fn:
            ...
            if (i.prevFnValue = A, null == A) return je("Custom function mappers may not return null (i.e. `" + i.name + "` for ele `" + e.id() + "` is null)"), !1;
            if (!(n = this.parse(i.name, A, i.bypass, "mapping"))) return je("Custom function mappers may not return invalid values for the property type (i.e. `" + i.name + "` for ele `" + e.id() + "` is invalid)"), !1;
            n.mapping = qe(i), i = n;
            break;
        case void 0:
            break;
    ...
    if (i.length > 0 && a > 0) {
        for (var s = {}, l = !1, u = 0; u < i.length; u++) {
            ...
            if (h) {
                var p = h.prev, f = null != h.next ? h.next : d, g = !1, v = void 0;
                p && (x(p.pfValue) && x(f.pfValue) ? (g = f.pfValue - p.pfValue, v = p.pfValue + 1e-6 * g) : x(p.value) && x(f.value) ? (g = f.value - p.value, v = p.value + 1e-6 * g) : m(p.value) && m(f.value) && (g = p.value[0] !== f.value[0] || p.value[1] !== f.value[1] || p.value[2] !== f.value[2], v = p.strValue), g && (s[c] = f.strValue, this.applyBypass(e, c, v), l = !0))
            }
        }
        if (!l) return;
        r.transitioning = !0, new vr((function (t) {
...
var Ss = {
    applyBypass: function (e, t, n, r) {
        ...
        for (var g = !1, y = 0; y < e.length; y++) {
            for (var m = e[y], x = {}, w = void 0, E = 0; E < i.length; E++) {
                ...
                g = this.applyParsedProperty(m, qe(k)) || g, r && (w.next = m.pstyle(k.name))
            }
    ...
    getRenderedStyle: function (e, t) {
        ...
        for (var n = {}, r = 0; r < t.length; r++) {
            ...
            void 0 !== a && (a = b(a) ? this.parse(i, a.strValue) : this.parse(i, a)), a && (n[i] = a)
        }
        return n
    }, getPropsList: function (e) {
        var t = [], n = e, r = this.properties;
        if (n) for (var i = Object.keys(n), a = 0; a < i.length; a++) {
            var o = i[a], s = n[o], l = r[o] || r[M(o)], u = this.parse(l.name, s);
            u && t.push(u)
        }
        return t
    }, getNonDefaultPropertiesHash: function (e, t, n) {
        var r, i, a, o, s, l, u = n.slice();
        for (s = 0; s < t.length; s++) if (r = t[s], null != (i = e.pstyle(r, !1))) if (null != i.pfValue) u[0] = Ce(o, u[0]), u[1] = Se(o, u[1]); else for (a = i.strValue, l = 0; l < a.length; l++) o = a.charCodeAt(l), u[0] = Ce(o, u[0]), u[1] = Se(o, u[1]);
        return u
    }
};
...
var Ts = {
    ...
    appendFromString: function (e) {
        ...
        for (i = i.replace(/[/][*](\s|.)+?[*][/]/g, ""); ;) {
            ...
            if (!s) {
                je("Halting stylesheet parsing: String stylesheet contains more to parse but no selector and block found in: " + i);
                break
            }
            t = s[0];
            var l = s[1];
            if ("core" !== l) if (new ka(l).invalid) {
                je("Skipping parsing of block: Invalid selector found in string stylesheet: " + l), a();
                continue
            }
            var u = s[2], c = !1;
            n = u;
            for (var d = []; ;) {
                ...
                if (!h) {
                    je("Skipping parsing of block: Invalid formatting of style property and value definitions found in:" + u), c = !0;
                    break
                }
                r = h[0];
                var p = h[1], f = h[2];
                if (this.properties[p]) this.parse(p, f) ? (d.push({
                    name: p,
                    val: f
                }), o()) : (je("Skipping property: Invalid property definition in: " + r), o()); else je("Skipping property: Invalid property name in: " + r), o()
            }
            if (c) {
                a();
                break
...
!function () {
    ...
    var i = {
        ...
        d = [{name: "events", type: a.bool, triggersZOrder: i.any}, {
            name: "text-events",
            type: a.bool,
        ...
        p = [{name: "overlay-padding", type: a.size, triggersBounds: i.any}, {
            name: "overlay-color",
            type: a.color
        ...
        f = [{name: "underlay-padding", type: a.size, triggersBounds: i.any}, {
            name: "underlay-color",
            type: a.color
        ...
        b = [{name: "border-color", type: a.color}, {
            ...
            name: "border-style",
            type: a.borderStyle
        }, {name: "border-cap", type: a.lineCap}, {name: "border-join", type: a.lineJoin}, {
            name: "border-dash-pattern",
            type: a.numbers
        }, {name: "border-dash-offset", type: a.number}, {name: "border-position", type: a.linePosition}],
        x = [{name: "outline-color", type: a.color}, {
        ...
        w = [{name: "background-image", type: a.urls}, {
        ...
        E = [{name: "position", type: a.position, triggersBounds: i.any}, {
        ...
        k = [{name: "line-style", type: a.lineStyle}, {name: "line-color", type: a.color}, {
            name: "line-fill",
            type: a.fill
        ...
        C = [{name: "ghost", type: a.bool, triggersBounds: i.any}, {
            name: "ghost-offset-x",
            type: a.bidirectionalSize,
            triggersBounds: i.any
            ...
            type: a.color
        }, {name: "outside-texture-bg-opacity", type: a.zeroOneNumber}], P = [];
    Ms.pieBackgroundN = 16, P.push({name: "pie-size", type: a.sizeMaybePercent});
    for (var T = 1; T <= Ms.pieBackgroundN; T++) P.push({
    ...
    var _ = [], M = Ms.arrowPrefixes = ["source", "mid-source", "target", "mid-target"];
    [{name: "arrow-shape", type: a.arrowShape, triggersBounds: i.any}, {
        name: "arrow-color",
        type: a.color
    }, {name: "arrow-fill", type: a.arrowFill}, {name: "arrow-width", type: a.arrowWidth}].forEach((function (e) {
        M.forEach((function (t) {
            var n = t + "-" + e.name, r = e.type, i = e.triggersBounds;
            _.push({name: n, type: r, triggersBounds: i})
        }))
    }), {});
    var B = Ms.properties = [].concat(d, g, h, p, f, C, c, u, o, s, l, m, b, x, w, P, E, k, _, S),
        N = Ms.propertyGroups = {
            behavior: d,
            transition: g,
            visibility: h,
    ...
    var A = Ms.aliases = [{name: "content", pointsTo: "label"}, {
    ...
    for (var R = 0; R < A.length; R++) {
        var V = A[R], F = B[V.pointsTo], j = {name: V.name, alias: !0, pointsTo: F};
        B.push(j), B[V.name] = j
    }
    ...
    for (var t = L({
    ...
    }, {"pie-size": "100%"}, [{name: "pie-{{i}}-background-color", value: "black"}, {
        name: "pie-{{i}}-background-size",
        value: "0%"
    }, {name: "pie-{{i}}-background-opacity", value: 1}].reduce((function (e, t) {
        ...
        name: "arrow-fill",
        value: "filled"
    }, {name: "arrow-width", value: 1}].reduce((function (e, t) {
        return Ms.arrowPrefixes.forEach((function (n) {
...
var Bs = {
    parse: function (e, t, n, r) {
        ...
        var i, a = _e(e, "" + t, n ? "t" : "f", "mapping" === r || !0 === r || !1 === r || null == r ? "dontcare" : r),
            o = this.propCache = this.propCache || [];
        return (i = o[a]) || (i = o[a] = this.parseImplWarn(e, t, n, r)), (n || "mapping" === r) && (i = qe(i)) && (i.value = qe(i.value)), i
    }, parseImplWarn: function (e, t, n, r) {
        var i = this.parseImpl(e, t, n, r);
        return i || null == t || je("The style property `".concat(e, ": ").concat(t, "` is invalid")), !i || "width" !== i.name && "height" !== i.name || "label" !== t || je("The style value of `label` is deprecated for `" + i.name + "`"), i
    }
};
Bs.parseImpl = function (e, t, n, r) {
    ...
    if (!s || r || t.length < 7 || "a" !== t[1]) ; else {
        ...
        if (t.length >= 10 && "m" === t[0] && (u = new RegExp(o.mapData.regex).exec(t))) {
            ...
            if (p.pfValue === f.pfValue || p.strValue === f.strValue) return je("`" + e + ": " + t + "` is not a valid mapper because the output range is zero; converting to `" + e + ": " + p.strValue + "`"), this.parse(e, p.strValue);
            if (c.color) {
                var g = p.value, b = f.value;
                if (!(g[0] !== b[0] || g[1] !== b[1] || g[2] !== b[2] || g[3] !== b[3] && (null != g[3] && 1 !== g[3] || null != b[3] && 1 !== b[3]))) return !1
            }
            return {
                name: e,
                value: u,
    ...
    if (c.multiple && "multiple" !== r) {
        var w;
        if (w = s ? t.split(/\s+/) : m(t) ? t : [t], c.evenMultiple && w.length % 2 != 0) return null;
        for (var E = [], k = [], C = [], S = "", P = !1, D = 0; D < w.length; D++) {
            var T = this.parse(e, w[D], n, "multiple");
            P = P || v(T.value), E.push(T.value), C.push(null != T.pfValue ? T.pfValue : T.value), k.push(T.units), S += (D > 0 ? " " : "") + T.strValue
        }
        return c.validate && !c.validate(E, k) ? null : c.singleEnum && P ? 1 === E.length && v(E[0]) ? {
            name: e,
            value: E[0],
            strValue: E[0],
            bypass: n
    ...
    if (c.number) {
        var z, A = "px";
        if (c.units && (z = c.units), c.implicitUnits && (A = c.implicitUnits), !c.unitless) if (s) {
        ...
        return c.unitless || "px" !== z && "em" !== z ? V.pfValue = t : V.pfValue = "px" !== z && z ? this.getEmSizeInPixels() * t : t, "ms" !== z && "s" !== z || (V.pfValue = "ms" === z ? t : 1e3 * t), "deg" !== z && "rad" !== z || (V.pfValue = "rad" === z ? t : (_ = t, Math.PI * _ / 180)), "%" === z && (V.pfValue = t / 100), V
    }
    if (c.propList) {
        var F = [], j = "" + t;
        if ("none" === j) ; else {
...
var Ns = function e(t) {
    ...
    S(t) ? (this._private = {
        cy: t,
        coreStyle: {}
    }, this.length = 0, this.resetToDefault()) : Ve("A style must have a core reference")
}, zs = Ns.prototype;
zs.instanceString = function () {
    ...
    var t = "core" === e ? null : new ka(e), n = this.length++;
    ...
    return this
}, zs.style = zs.css, zs.cssRule = function (e, t) {
    ...
    return P(e) ? e.appendToStyle(this) : m(e) ? this.appendFromJson(e) : v(e) && this.appendFromString(e), this
    ...
    L(zs, e)
})), Ns.types = zs.types, Ns.properties = zs.properties, Ns.propertyGroups = zs.propertyGroups, Ns.propertyGroupNames = zs.propertyGroupNames, Ns.propertyGroupKeys = zs.propertyGroupKeys;
var Is = {
    style: function (e) {
        ...
        var t = this._private;
        return P(e) ? t.style = e.generateStyle(this) : m(e) ? t.style = Ns.fromJson(this, e) : v(e) ? t.style = Ns.fromString(this, e) : t.style = Ns(this), t.style
    ...
    autolock: function (e) {
        ...
        switch (a.length) {
            ...
            case 1:
                ...
                if (b(a[0])) {
                    ...
                    r = (n = a[0]).x, i = n.y, x(r) && (o.x = r), x(i) && (o.y = i), this.emit("pan viewport")
                }
                break;
            case 2:
                if (!this._private.panningEnabled) return this;
                e = a[0], t = a[1], "x" !== e && "y" !== e || !x(t) || (o[e] = t), this.emit("pan viewport")
        }
        ...
        switch (s.length) {
            case 1:
                b(e) && (a = (i = s[0]).x, o = i.y, x(a) && (l.x += a), x(o) && (l.y += o), this.emit("pan viewport"));
                break;
            case 2:
                r = t, "x" !== (n = e) && "y" !== n || !x(r) || (l[n] += r), this.emit("pan viewport")
        }
        return this.notify("viewport"), this
    }, fit: function (e, t) {
        ...
        if (x(e) && void 0 === t && (t = e, e = void 0), this._private.panningEnabled && this._private.zoomingEnabled) {
            var n, r;
            if (v(e)) {
                var i = e;
                e = this.$(i)
            ...
            if (!E(e) || !e.empty()) {
                ...
                if (t = x(t) ? t : 0, !isNaN(s) && !isNaN(l) && s > 0 && l > 0 && !isNaN(n.w) && !isNaN(n.h) && n.w > 0 && n.h > 0) return {
        ...
        return x(e) && x(t) && e <= t ? (n.minZoom = e, n.maxZoom = t) : x(e) && void 0 === t && e <= n.maxZoom ? n.minZoom = e : x(t) && void 0 === e && t >= n.minZoom && (n.maxZoom = t), this
    }, minZoom: function (e) {
        ...
        if (r.zoomingEnabled || (o = !0), x(e) ? n = e : b(e) && (n = e.level, null != e.position ? t = yt(e.position, a, i) : null != e.renderedPosition && (t = e.renderedPosition), null == t || r.panningEnabled || (o = !0)), n = (n = n > r.maxZoom ? r.maxZoom : n) < r.minZoom ? r.minZoom : n, o || !x(n) || n === a || null != t && (!x(t.x) || !x(t.y))) return null;
        if (null != t) {
            var s = i, l = a, u = n;
            return {
                zoomed: !0,
        ...
        if (r && (!a || !e.cancelOnFailedZoom) && t.panningEnabled) {
            var l = e.pan;
            x(l.x) && (t.pan.x = l.x, o = !1), x(l.y) && (t.pan.y = l.y, o = !1), o || i.push("pan")
        }
        ...
        var e, t, n = this._private, r = n.container, i = this;
        return n.sizeCache = n.sizeCache || (r ? (e = i.window().getComputedStyle(r), t = function (t) {
...
As.centre = As.center, As.autolockNodes = As.autolock, As.autoungrabifyNodes = As.autoungrabify;
var Ls = {
    data: Fi.data({
        field: "data",
        bindingEvent: "data",
...
var Os = function (e) {
    var t = this, n = (e = L({}, e)).container;
    n && !w(n) && w(n[0]) && (n = n[0]);
    var r = n ? n._cyreg : null;
    (r = r || {}) && r.cy && (r.cy.destroy(), r = {});
    var i = r.readies = r.readies || [];
    n && (n._cyreg = r), r.cy = t;
    var a = void 0 !== u && void 0 !== n && !e.headless, o = e;
    o.layout = L({name: a ? "grid" : "null"}, o.layout), o.renderer = L({name: a ? "canvas" : "null"}, o.renderer);
    var s = function (e, t, n) {
        ...
        pan: {x: b(o.pan) && x(o.pan.x) ? o.pan.x : 0, y: b(o.pan) && x(o.pan.y) ? o.pan.y : 0},
    ...
    !function (e, t) {
        ...
        var n = e[0], a = e[1];
        l.styleEnabled && t.style().append(n), function (e, n, r) {
            t.notifications(!1);
            var i = t.mutableElements();
            i.length > 0 && i.remove(), null != e && (b(e) || m(e)) && t.add(e), t.one("layoutready", (function (e) {
            ...
            t.startAnimationLoop(), l.ready = !0, y(o.ready) && t.on("ready", o.ready);
...
L(Rs, {
    instanceString: function () {
        ...
        if (null != e) {
            ...
            return !w(e) && w(e[0]) && (e = e[0]), t.stopAnimationLoop(), t.destroyRenderer(), n.container = e, n.styleEnabled = !0, t.invalidateSize(), t.initRenderer(L({}, r, r.renderer, {name: "null" === r.renderer.name ? "canvas" : r.renderer.name})), t.startAnimationLoop(), t.style(r.style), t.emit("mount"), t
        }
    }, unmount: function () {
        var e = this;
            ...
            if (t.startBatch(), e.elements) {
                var i = {}, a = function (e, n) {
                    for (var r = [], a = [], o = 0; o < e.length; o++) {
                        ...
                        } else je("cy.json() cannot handle elements without an ID attribute")
                    }
                    t.add(r);
                ...
                if (m(e.elements)) a(e.elements); else for (var o = ["nodes", "edges"], s = 0; s < o.length; s++) {
        ...
        }))), this._private.styleEnabled && (f.style = t.style().json()), f.data = qe(t.data());
        var g = n.options;
        return f.zoomingEnabled = n.zoomingEnabled, f.userZoomingEnabled = n.userZoomingEnabled, f.zoom = n.zoom, f.minZoom = n.minZoom, f.maxZoom = n.maxZoom, f.panningEnabled = n.panningEnabled, f.userPanningEnabled = n.userPanningEnabled, f.pan = qe(n.pan), f.boxSelectionEnabled = n.boxSelectionEnabled, f.renderer = qe(g.renderer), f.hideEdgesOnViewport = g.hideEdgesOnViewport, f.textureOnViewport = g.textureOnViewport, f.wheelSensitivity = g.wheelSensitivity, f.motionBlur = g.motionBlur, f.multiClickDebounceTime = g.multiClickDebounceTime, f
    }
}), Rs.$id = Rs.getElementById, [rs, fs, ys, ms, bs, xs, Es, ks, Is, As, Ls].forEach((function (e) {
    L(Rs, e)
}));
var Vs = {
    fit: !0,
...
}, Fs = {maximal: !1, acyclic: !1}, js = function (e) {
...
Ys.prototype.run = function () {
    var e, t = this.options, n = t, r = t.cy, i = n.eles, a = i.nodes().filter((function (e) {
            return !e.isParent()
        })), o = i, s = n.directed, l = n.acyclic || n.maximal || n.maximalAdjustments > 0,
        u = _t(n.boundingBox ? n.boundingBox : {x1: 0, y1: 0, w: r.width(), h: r.height()});
    if (E(n.roots)) e = n.roots; else if (m(n.roots)) {
        for (var c = [], d = 0; d < n.roots.length; d++) {
            var h = n.roots[d], p = r.getElementById(h);
            c.push(p)
        }
        e = r.collection(c)
    } else if (v(n.roots)) e = r.$(n.roots); else if (s) e = a.roots(); else {
        var f = i.components();
        e = r.collection();
        for (var g = function (t) {
            var n = f[t], r = n.maxDegree(!1), i = n.filter((function (e) {
                return e.degree(!1) === r
            }));
            e = e.add(i)
        }, y = 0; y < f.length; y++) g(y)
    }
    var b = [], x = {}, w = function (e, t) {
        null == b[t] && (b[t] = []);
        var n = b[t].length;
    ...
    var P = function (e) {
        ...
        for (var r = js(e), a = e.incomers().filter((function (e) {
        ...
        if (r.depth <= o) {
            ...
            var d = o + 1;
            return function (e, t) {
                var n = js(e), r = n.depth, i = n.index;
                b[r][i] = null, w(e, t)
            }(e, d), t[s] = d, !0
        }
        return !1
    ...
    if (s && l) {
        var _ = [], M = {}, B = function (e) {
            return _.push(e)
        };
        for (a.forEach((function (e) {
            return _.push(e)
        })); _.length > 0;) {
            var N = _.shift(), z = T(N, M);
            if (z) N.outgoers().filter((function (e) {
                return e.isNode() && i.has(e)
            })).forEach(B); else if (null === z) {
                je("Detected double maximal shift for node `" + N.id() + "`.  Bailing maximal adjustment due to cycle.  Use `options.maximal: true` only on DAGs.");
                break
            }
        }
    }
    ...
    var F = {}, j = function (e) {
        ...
        for (var t = js(e).depth, n = e.neighborhood(), r = 0, i = 0, o = 0; o < n.length; o++) {
            var s = n[o];
    ...
    var G = u.x1 + u.w / 2, U = u.x1 + u.h / 2, Z = b.reduce((function (e, t) {
        return Math.max(e, t.length)
    }), 0);
    return i.nodes().layoutPositions(this, n, (function (e) {
        var t = js(e), r = t.depth, i = t.index, a = b[r].length, o = Math.max(u.w / ((n.grid ? Z : a) + 1), I),
            s = Math.max(u.h / (b.length + 1), I), l = Math.min(u.w / 2 / b.length, u.h / 2 / b.length);
...
Ws.prototype.run = function () {
    ...
    for (var o, s = _t(t.boundingBox ? t.boundingBox : {
        x1: 0,
        y1: 0,
        w: n.width(),
        h: n.height()
    ...
    if (o = x(t.radius) ? t.radius : a.length <= 1 ? 0 : Math.min(s.h, s.w) / 2 - d, a.length > 1 && t.avoidOverlap) {
        d *= 1.75;
        var v = Math.cos(c) - Math.cos(0), y = Math.sin(c) - Math.sin(0), m = Math.sqrt(d * d / (v * v + y * y));
        o = Math.max(m, o)
    }
...
Gs.prototype.run = function () {
    for (var e = this.options, t = e, n = void 0 !== t.counterclockwise ? !t.counterclockwise : t.clockwise, r = e.cy, i = t.eles, a = i.nodes().not(":parent"), o = _t(t.boundingBox ? t.boundingBox : {
        x1: 0,
        y1: 0,
        w: r.width(),
        h: r.height()
    ...
    for (var C = 0, S = 0; S < y.length; S++) {
        var P = y[S], D = void 0 === t.sweep ? 2 * Math.PI - 2 * Math.PI / P.length : t.sweep,
...
Zs.prototype.run = function () {
    ...
    var i = we(), a = function () {
        ...
        return !(n.stopped || t >= e.numIter) && (rl(r, e), r.temperature = r.temperature * e.coolingFactor, !(r.temperature < e.minTemp))
    }, s = function () {
        if (!0 === e.animate || !1 === e.animate) a(), n.one("layoutstop", e.stop), n.emit({
            type: "layoutstop",
            layout: n
        }); else {
            var t = e.eles.nodes(), i = tl(r, e, t);
...
var $s = function (e, t, n) {
    for (var r = n.eles.edges(), i = n.eles.nodes(), a = _t(n.boundingBox ? n.boundingBox : {
        x1: 0,
        y1: 0,
        w: e.width(),
        h: e.height()
    ...
    for (u = 0; u < o.edgeSize; u++) {
        ...
        var D = y(n.idealEdgeLength) ? n.idealEdgeLength(S) : n.idealEdgeLength,
            T = y(n.edgeElasticity) ? n.edgeElasticity(S) : n.edgeElasticity, _ = o.idToIndex[P.sourceId],
            M = o.idToIndex[P.targetId];
        if (o.indexToGraph[_] != o.indexToGraph[M]) {
            for (var B = Qs(P.sourceId, P.targetId, o), N = o.graphSet[B], z = 0, I = o.layoutNodes[_]; -1 === N.indexOf(I.id);) I = o.layoutNodes[o.idToIndex[I.parentId]], z++;
    ...
    var r = n.layout, i = n.eles.nodes(), a = tl(e, n, i);
    ...
    if (e.cmptId === t.cmptId || n.isCompound) {
        ...
        if (o > 0) var s = (u = r.nodeOverlap * o) * i / (g = Math.sqrt(i * i + a * a)), l = u * a / g; else {
            var u, c = ll(e, i, a), d = ll(t, -1 * i, -1 * a), h = d.x - c.x, p = d.y - c.y, f = h * h + p * p,
                g = Math.sqrt(f);
    ...
    for (var n = 0; n < e.edgeSize; n++) {
        ...
        if (0 !== l || 0 !== u) {
            var c = ll(a, l, u), d = ll(s, -1 * l, -1 * u), h = d.x - c.x, p = d.y - c.y, f = Math.sqrt(h * h + p * p),
    ...
    for (n = 0; n < e.nodeSize; n++) {
        if (!(0 < (i = e.layoutNodes[n]).children.length || i.isLocked)) {
            ...
            i.positionX += r.x, i.positionY += r.y, i.offsetX = 0, i.offsetY = 0, i.minX = i.positionX - i.width, i.maxX = i.positionX + i.width, i.minY = i.positionY - i.height, i.maxY = i.positionY + i.height, fl(i, e)
        }
    }
    for (n = 0; n < e.nodeSize; n++) {
        var i;
...
wl.prototype.run = function () {
    var e = this.options, t = e.eles.nodes(), n = y(e.positions);
...
var Cl = [{name: "breadthfirst", impl: Ys}, {name: "circle", impl: Ws}, {name: "concentric", impl: Gs}, {
    name: "cose",
    impl: Zs
}, {name: "grid", impl: yl}, {name: "null", impl: bl}, {name: "preset", impl: wl}, {name: "random", impl: kl}];
...
Sl.prototype = {
    recalculateRenderedStyle: Pl, notify: function () {
        this.notifications++
    }, init: Pl, isHeadless: function () {
        return !0
    }, png: Dl, jpg: Dl
};
var Tl = {
    arrowShapeWidth: .3, registerArrowShapes: function () {
        ...
        s("none", {
            ...
            collide: function (e, t, n, r, o, s, l) {
                var u = o, c = Math.pow(u.x - e, 2) + Math.pow(u.y - t, 2) <= Math.pow((n + 2 * l) * this.radius, 2),
    ...
    projectIntoViewport: function (e, t) {
        var n = this.cy, r = this.findContainerClientCoords(), i = r[0], a = r[1], o = r[4], s = n.pan(), l = n.zoom();
        return [((e - i) / o - s.x) / l, ((t - a) / o - s.y) / l]
    }, findContainerClientCoords: function () {
        if (this.containerBB) return this.containerBB;
        var e = this.container, t = e.getBoundingClientRect(), n = this.cy.window().getComputedStyle(e),
            r = function (e) {
                return parseFloat(n.getPropertyValue(e))
            }, i = r("padding-left"), a = r("padding-right"), o = r("padding-top"), s = r("padding-bottom"),
            l = r("border-left-width"), u = r("border-right-width"), c = r("border-top-width"),
            d = (r("border-bottom-width"), e.clientWidth), h = e.clientHeight, p = i + a, f = o + s, g = l + u,
            v = t.width / (d + g), y = d - p, m = h - f, b = t.left + i + l, x = t.top + o + c;
        ...
        function m(n) {
            ...
            if ("segments" === a.edgeType || "straight" === a.edgeType || "haystack" === a.edgeType) {
                for (var x = a.allpts, w = 0; w + 3 < x.length; w += 2) if (Vt(e, t, x[w], x[w + 1], x[w + 2], x[w + 3], g) && f > (r = qt(e, t, x[w], x[w + 1], x[w + 2], x[w + 3]))) return v(n, r), !0
            } else if ("bezier" === a.edgeType || "multibezier" === a.edgeType || "self" === a.edgeType || "compound" === a.edgeType) for (x = a.allpts, w = 0; w + 5 < a.allpts.length; w += 4) if (Ft(e, t, x[w], x[w + 1], x[w + 2], x[w + 3], x[w + 4], x[w + 5], g) && f > (r = jt(e, t, x[w], x[w + 1], x[w + 2], x[w + 3], x[w + 4], x[w + 5]))) return v(n, r), !0;
            ...
            for (w = 0; w < k.length; w++) {
                ...
                if (S.roughCollide(e, t, E, C.angle, {x: C.x, y: C.y}, P, h) && S.collide(e, t, E, C.angle, {
                    x: C.x,
                    y: C.y
                }, P, h)) return v(n), !0
            }
        ...
        function x(n, r) {
            ...
            if ("yes" === n.pstyle("text-events").strValue && l) {
                var u = b(a.rscratch, "labelX", r), c = b(a.rscratch, "labelY", r), d = b(a.rscratch, "labelAngle", r),
                    h = n.pstyle(i + "text-margin-x").pfValue, p = n.pstyle(i + "text-margin-y").pfValue,
                    g = s.x1 - o - h, y = s.x2 + o - h, m = s.y1 - o - p, x = s.y2 + o - p;
                if (d) {
                    var w = Math.cos(d), E = Math.sin(d), k = function (e, t) {
                            return {x: (e -= u) * w - (t -= c) * E + u, y: e * E + t * w + c}
                        }, C = k(g, m), S = k(g, x), P = k(y, m), D = k(y, x),
        ...
        for (var i, a, o = this.getCachedZSortedEles().interactive, s = [], l = Math.min(e, n), u = Math.max(e, n), c = Math.min(t, r), d = Math.max(t, r), h = _t({
            x1: e = l,
            y1: t = c,
            x2: n = u,
            y2: r = d
            ...
            if (f.isNode()) {
                ...
                if (null != b.startX && null != b.startY && !Lt(h, b.startX, b.startY)) continue;
                ...
                if ("bezier" === b.edgeType || "multibezier" === b.edgeType || "self" === b.edgeType || "compound" === b.edgeType || "segments" === b.edgeType || "haystack" === b.edgeType) {
                    for (var x = m.rstyle.bezierPts || m.rstyle.linePts || m.rstyle.haystackPts, w = !0, E = 0; E < x.length; E++) if (i = h, a = x[E], !Lt(i, a.x, a.y)) {
                        w = !1;
                        break
                    }
                    w && s.push(y)
    ...
    calculateArrowAngles: function (e) {
        ...
        if (l ? (r = s.haystackPts[0], i = s.haystackPts[1], a = s.haystackPts[2], o = s.haystackPts[3]) : (r = s.arrowStartX, i = s.arrowStartY, a = s.arrowEndX, o = s.arrowEndY), g = s.midX, v = s.midY, d) t = r - s.segpts[0], n = i - s.segpts[1]; else if (c || h || p || u) {
            var f = s.allpts;
            t = r - Pt(f[0], f[2], f[4], .1), n = i - Pt(f[1], f[3], f[5], .1)
        } else t = r - g, n = i - v;
        ...
        if (l && (g = (r + a) / 2, v = (i + o) / 2), t = a - r, n = o - i, d) if ((f = s.allpts).length / 2 % 2 == 0) {
        ...
        } else if (s.isRound) t = s.midVector[1], n = -s.midVector[0]; else {
            y = (S = f.length / 2 - 1) - 2;
            t = f[S] - f[y], n = f[S + 1] - f[y + 1]
        } else if (c || h || p) {
            ...
            if (s.ctrlpts.length / 2 % 2 == 0) {
                ...
                m = Pt(f[C], f[k], f[E], 0), b = Pt(f[C + 1], f[k + 1], f[E + 1], 0), x = Pt(f[C], f[k], f[E], 1e-4), w = Pt(f[C + 1], f[k + 1], f[E + 1], 1e-4)
            } else {
                var k, C;
                E = (k = f.length / 2 - 1) + 2;
                m = Pt(f[C = k - 2], f[k], f[E], .4999), b = Pt(f[C + 1], f[k + 1], f[E + 1], .4999), x = Pt(f[C], f[k], f[E], .5), w = Pt(f[C + 1], f[k + 1], f[E + 1], .5)
            }
            t = x - m, n = w - b
        }
        if (s.midtgtArrowAngle = xt(t, n), s.midDispX = t, s.midDispY = n, t *= -1, n *= -1, d) if ((f = s.allpts).length / 2 % 2 == 0) ; else if (!s.isRound) {
            var S, P = (S = f.length / 2 - 1) + 2;
            t = -(f[P] - f[S]), n = -(f[P + 1] - f[S + 1])
        }
        if (s.midsrcArrowAngle = xt(t, n), d) t = a - s.segpts[s.segpts.length - 2], n = o - s.segpts[s.segpts.length - 1]; else if (c || h || p || u) {
            var D = (f = s.allpts).length;
            t = a - Pt(f[D - 6], f[D - 4], f[D - 2], .9), n = o - Pt(f[D - 5], f[D - 3], f[D - 1], .9)
        } else t = a - g, n = o - v;
...
var Bl, Nl, zl, Il, Al, Ll, Ol, Rl, Vl, Fl, jl, ql, Yl, Xl, Wl, Hl, Kl, Gl = {}, Ul = {}, Zl = function (e, t, n) {
    n.x = t.x - e.x, n.y = t.y - e.y, n.len = Math.sqrt(n.x * n.x + n.y * n.y), n.nx = n.x / n.len, n.ny = n.y / n.len, n.ang = Math.atan2(n.ny, n.nx)
}, $l = function (e, t, n, r, i) {
    var a, o;
    if (e !== Kl ? Zl(t, e, Gl) : ((o = Gl).x = -1 * (a = Ul).x, o.y = -1 * a.y, o.nx = -1 * a.nx, o.ny = -1 * a.ny, o.ang = a.ang > 0 ? -(Math.PI - a.ang) : Math.PI + a.ang), Zl(t, n, Ul), zl = Gl.nx * Ul.ny - Gl.ny * Ul.nx, Il = Gl.nx * Ul.nx - Gl.ny * -Ul.ny, Ol = Math.asin(Math.max(-1, Math.min(1, zl))), Math.abs(Ol) < 1e-6) return Bl = t.x, Nl = t.y, void (Vl = jl = 0);
    Al = 1, Ll = !1, Il < 0 ? Ol < 0 ? Ol = Math.PI + Ol : (Ol = Math.PI - Ol, Al = -1, Ll = !0) : Ol > 0 && (Al = -1, Ll = !0), jl = void 0 !== t.radius ? t.radius : r, Rl = Ol / 2, ql = Math.min(Gl.len / 2, Ul.len / 2), i ? (Fl = Math.abs(Math.cos(Rl) * jl / Math.sin(Rl))) > ql ? (Fl = ql, Vl = Math.abs(Fl * Math.sin(Rl) / Math.cos(Rl))) : Vl = jl : (Fl = Math.min(ql, jl), Vl = Math.abs(Fl * Math.sin(Rl) / Math.cos(Rl))), Wl = t.x + Ul.nx * Fl, Hl = t.y + Ul.ny * Fl, Bl = Wl - Ul.ny * Vl * Al, Nl = Hl + Ul.nx * Vl * Al, Yl = t.x + Gl.nx * Fl, Xl = t.y + Gl.ny * Fl, Kl = t
};
...
eu.findMidptPtsEtc = function (e, t) {
    var n, r = t.posPts, i = t.intersectionPts, o = t.vectorNormInverse, s = e.pstyle("source-endpoint"),
        l = e.pstyle("target-endpoint"), u = null != s.units && null != l.units;
    switch (e.pstyle("edge-distances").value) {
        ...
        case"endpoints":
            if (u) {
                var c = a(this.manualEndptToPx(e.source()[0], s), 2), d = c[0], h = c[1],
                    p = a(this.manualEndptToPx(e.target()[0], l), 2), f = p[0], g = p[1],
                    v = {x1: d, y1: h, x2: f, y2: g};
                o = function (e, t, n, r) {
                    var i = r - t, a = n - e, o = Math.sqrt(a * a + i * i);
                    return {x: -i / o, y: a / o}
                }(d, h, f, g), n = v
            } else je("Edge ".concat(e.id(), " has edge-distances:endpoints specified without manual endpoints specified via source-endpoint and target-endpoint.  Falling back on edge-distances:intersection (default).")), n = i
    }
    ...
    for (var t = 0; t < e.length; t++) {
        ...
        if (!i.haystack) {
            ...
            i.source = {x: Math.cos(a), y: Math.sin(a)}, a = 2 * Math.random() * Math.PI, i.target = {
                x: Math.cos(a),
                y: Math.sin(a)
            }
        }
    ...
    var n = e._private.rscratch, r = e.pstyle("segment-weights"), i = e.pstyle("segment-distances"),
        a = e.pstyle("segment-radii"), o = e.pstyle("radius-type"), s = Math.min(r.pfValue.length, i.pfValue.length),
        l = a.pfValue[a.pfValue.length - 1], u = o.pfValue[o.pfValue.length - 1];
    n.edgeType = "segments", n.segpts = [], n.radii = [], n.isArcRadius = [];
    for (var c = 0; c < s; c++) {
        var d = r.pfValue[c], h = i.pfValue[c], p = 1 - d, f = d, g = this.findMidptPtsEtc(e, t), v = g.midptPts,
            y = g.vectorNormInverse, m = {x: v.x1 * p + v.x2 * f, y: v.y1 * p + v.y2 * f};
    ...
    var i = e.source(), a = e.target();
    console.log("[Cytoscape Forked] Using custom findCompoundLoopPoints() for edge:", e.id(), " src:", i.id(), " tgt:", a.id());
    var o = e._private.rscratch;
    o.edgeType = "compound";
    var s = t.srcPos, l = t.tgtPos, u = e.pstyle("control-point-step-size").pfValue,
        c = e.pstyle("control-point-distances"), d = c ? c.pfValue[0] : void 0, h = n, p = u;
    r && (h = 0, p = d);
    var f = s.x, g = s.y, v = {x: (f + l.x) / 2, y: (g + l.y) / 2}, y = p * (h + 1);
    o.ctrlpts = [v.x, v.y - y, v.x - y, v.y], console.log("[Cytoscape Forked] Control points set for edge:", e.id(), o.ctrlpts)
}, eu.findStraightEdgePoints = function (e) {
    e._private.rscratch.edgeType = "straight"
}, eu.findBezierPoints = function (e, t, n, r, i) {
    var a = e._private.rscratch, o = e.pstyle("control-point-step-size").pfValue,
        s = e.pstyle("control-point-distances"), l = e.pstyle("control-point-weights"),
        u = s && l ? Math.min(s.value.length, l.value.length) : 1, c = s ? s.pfValue[0] : void 0, d = l.value[0], h = r;
    a.edgeType = h ? "multibezier" : "bezier", a.ctrlpts = [];
    for (var p = 0; p < u; p++) {
        var f = (.5 - t.eles.length / 2 + n) * o * (i ? -1 : 1), g = void 0, v = Et(f);
        h && (c = s ? s.pfValue[p] : o, d = l.value[p]);
        var y = void 0 !== (g = r ? c : void 0 !== c ? v * c : void 0) ? g : f, m = 1 - d, b = d,
            x = this.findMidptPtsEtc(e, t), w = x.midptPts, E = x.vectorNormInverse,
    ...
    var C, S = "vertical" === u, P = S ? E : w, D = S ? b : m, T = Et(D), _ = !1;
    ...
    }, B = M(C), N = M(Math.abs(P) - Math.abs(C));
    if ((B || N) && !_) if (S) {
    ...
    if (n.isRound) {
        var te = e.pstyle("taxi-radius").value, ne = "arc-radius" === e.pstyle("radius-type").value[0];
    ...
    if ("bezier" === n.edgeType) {
        var r = t.srcPos, i = t.tgtPos, a = t.srcW, o = t.srcH, s = t.tgtW, l = t.tgtH, u = t.srcShape, c = t.tgtShape,
            d = t.srcCornerRadius, h = t.tgtCornerRadius, p = t.srcRs, f = t.tgtRs, g = !x(n.startX) || !x(n.startY),
            v = !x(n.arrowStartX) || !x(n.arrowStartY), y = !x(n.endX) || !x(n.endY),
            m = !x(n.arrowEndX) || !x(n.arrowEndY),
            b = 3 * (this.getArrowWidth(e.pstyle("width").pfValue, e.pstyle("arrow-scale").value) * this.arrowShapeWidth),
            w = kt({x: n.ctrlpts[0], y: n.ctrlpts[1]}, {x: n.startX, y: n.startY}), E = w < b,
            k = kt({x: n.ctrlpts[0], y: n.ctrlpts[1]}, {x: n.endX, y: n.endY}), C = k < b, S = !1;
        if (g || v || E) {
            S = !0;
            var P = {x: n.ctrlpts[0] - r.x, y: n.ctrlpts[1] - r.y}, D = Math.sqrt(P.x * P.x + P.y * P.y),
                T = {x: P.x / D, y: P.y / D}, _ = Math.max(a, o),
                M = {x: n.ctrlpts[0] + 2 * T.x * _, y: n.ctrlpts[1] + 2 * T.y * _},
                B = u.intersectLine(r.x, r.y, a, o, M.x, M.y, 0, d, p);
            E ? (n.ctrlpts[0] = n.ctrlpts[0] + T.x * (b - w), n.ctrlpts[1] = n.ctrlpts[1] + T.y * (b - w)) : (n.ctrlpts[0] = B[0] + T.x * b, n.ctrlpts[1] = B[1] + T.y * b)
        }
        if (y || m || C) {
            S = !0;
            var N = {x: n.ctrlpts[0] - i.x, y: n.ctrlpts[1] - i.y}, z = Math.sqrt(N.x * N.x + N.y * N.y),
                I = {x: N.x / z, y: N.y / z}, A = Math.max(a, o),
                L = {x: n.ctrlpts[0] + 2 * I.x * A, y: n.ctrlpts[1] + 2 * I.y * A},
                O = c.intersectLine(i.x, i.y, s, l, L.x, L.y, 0, h, f);
            C ? (n.ctrlpts[0] = n.ctrlpts[0] + I.x * (b - k), n.ctrlpts[1] = n.ctrlpts[1] + I.y * (b - k)) : (n.ctrlpts[0] = O[0] + I.x * b, n.ctrlpts[1] = O[1] + I.y * b)
        }
    ...
    if ("multibezier" === t.edgeType || "bezier" === t.edgeType || "self" === t.edgeType || "compound" === t.edgeType) {
        ...
        var r;
        t.allpts.push(t.endX, t.endY), t.ctrlpts.length / 2 % 2 == 0 ? (r = t.allpts.length / 2 - 1, t.midX = t.allpts[r], t.midY = t.allpts[r + 1]) : (r = t.allpts.length / 2 - 3, .5, t.midX = Pt(t.allpts[r], t.allpts[r + 2], t.allpts[r + 4], .5), t.midY = Pt(t.allpts[r + 1], t.allpts[r + 3], t.allpts[r + 5], .5))
    } else if ("straight" === t.edgeType) t.allpts = [t.startX, t.startY, t.endX, t.endY], t.midX = (t.startX + t.endX + t.arrowStartX + t.arrowEndX) / 4, t.midY = (t.startY + t.endY + t.arrowStartY + t.arrowEndY) / 4; else if ("segments" === t.edgeType) {
        if (t.allpts = [], t.allpts.push(t.startX, t.startY), t.allpts.push.apply(t.allpts, t.segpts), t.allpts.push(t.endX, t.endY), t.isRound) {
            ...
            for (var i = 2; i + 3 < t.allpts.length; i += 2) {
                var a = t.radii[i / 2 - 1], o = t.isArcRadius[i / 2 - 1];
                t.roundCorners.push(Jl({x: t.allpts[i - 2], y: t.allpts[i - 1]}, {
                    x: t.allpts[i],
                    y: t.allpts[i + 1],
                    radius: a
                }, {x: t.allpts[i + 2], y: t.allpts[i + 3]}, a, o))
            }
        }
        if (t.segpts.length % 4 == 0) {
            ...
            if (t.isRound) {
                var c = {x: t.segpts[u], y: t.segpts[u + 1]}, d = t.roundCorners[u / 2], h = [c.x - d.cx, c.y - d.cy],
    ...
    t.nodesOverlap || x(t.startX) && x(t.startY) && x(t.endX) && x(t.endY) ? t.loggedErr = !1 : t.loggedErr || (t.loggedErr = !0, je("Edge `" + e.id() + "` has invalid endpoints and so it is impossible to draw.  Adjust your edge style (e.g. control points) accordingly or use an alternative edge type.  This is expected behaviour when the source node and the target node overlap."))
}, eu.findEdgeControlPoints = function (e) {
    var t = this;
    if (e && 0 !== e.length) {
        for (var n = this, r = n.cy.hasCompoundNodes(), i = {
            map: new $e, get: function (e) {
                var t = this.map.get(e[0]);
                return null != t ? t.get(e[1]) : null
            }, set: function (e, t) {
                var n = this.map.get(e[0]);
                null == n && (n = new $e, this.map.set(e[0], n)), n.set(e[1], t)
            }
        ...
        for (var y = function (e) {
            ...
            if (!s.hasUnbundled) {
                ...
                Ge(s.eles), u.forEach((function (e) {
            ...
            var f = s.srcPos = d.position(), g = s.tgtPos = h.position(), v = s.srcW = d.outerWidth(),
                y = s.srcH = d.outerHeight(), m = s.tgtW = h.outerWidth(), b = s.tgtH = h.outerHeight(),
                ...
                S = s.tgtRs = h._private.rscratch, P = s.srcRs = d._private.rscratch;
            s.dirCounts = {
                north: 0,
                west: 0,
                south: 0,
            ...
            for (var D = 0; D < s.eles.length; D++) {
                var T = s.eles[D], _ = T[0]._private.rscratch, M = T.pstyle("curve-style").value,
                ...
                if (!s.calculatedIntersection && d !== h && (s.hasBezier || s.hasUnbundled)) {
                    ...
                    var z = w.intersectLine(f.x, f.y, v, y, g.x, g.y, 0, k, P), I = s.srcIntn = z,
                        A = E.intersectLine(g.x, g.y, m, b, f.x, f.y, 0, C, S), L = s.tgtIntn = A,
                        O = s.intersectionPts = {x1: z[0], x2: A[0], y1: z[1], y2: A[1]},
                        R = s.posPts = {x1: f.x, x2: g.x, y1: f.y, y2: g.y}, V = A[1] - z[1], F = A[0] - z[0],
                        j = Math.sqrt(F * F + V * V), q = s.vector = {x: F, y: V},
                        Y = s.vectorNorm = {x: q.x / j, y: q.y / j}, X = {x: -Y.y, y: Y.x};
                    s.nodesOverlap = !x(j) || E.checkPoint(z[0], z[1], 0, m, b, g.x, g.y, C, S) || w.checkPoint(A[0], A[1], 0, v, y, f.x, f.y, k, P), s.vectorNormInverse = X, l = {
    ...
    var n = t.edgeType;
    if ("bezier" === n || "multibezier" === n || "self" === n || "compound" === n) return tu(t.ctrlpts)
...
var nu = {
    manualEndptToPx: function (e, t) {
        var n = e.position(), r = e.outerWidth(), i = e.outerHeight(), a = e._private.rscratch;
        if (2 === t.value.length) {
        ...
        var s = t.pfValue[0];
        s = -Math.PI / 2 + s;
        var l = 2 * Math.max(r, i), u = [n.x + Math.cos(s) * l, n.y + Math.sin(s) * l];
        ...
        var t, n, r, i, a, o = this, s = e.source()[0], l = e.target()[0], u = s.position(), c = l.position(),
            ...
            g = s._private.rscratch, v = l._private.rscratch, y = e.pstyle("curve-style").value,
            m = e._private.rscratch, b = m.edgeType, w = "self" === b || "compound" === b,
            E = "bezier" === b || "multibezier" === b || w, k = "bezier" !== b,
            C = "straight" === b || "segments" === b, S = "segments" === b, P = E || k || C, D = w || "taxi" === y,
            T = e.pstyle("source-endpoint"), _ = D ? "outside-to-node" : T.value,
            M = "auto" === s.pstyle("corner-radius").value ? "auto" : s.pstyle("corner-radius").pfValue,
            B = e.pstyle("target-endpoint"), N = D ? "outside-to-node" : B.value,
        ...
        if ("inside-to-node" === N) t = [c.x, c.y]; else if (B.units) t = this.manualEndptToPx(l, B); else if ("outside-to-line" === N) t = m.tgtIntn; else if ("outside-to-node" === N || "outside-to-node-or-label" === N ? i = n : "outside-to-line" !== N && "outside-to-line-or-label" !== N || (i = [u.x, u.y]), t = o.nodeShapes[this.getNodeShape(l)].intersectLine(c.x, c.y, l.outerWidth(), l.outerHeight(), i[0], i[1], 0, z, v), "outside-to-node-or-label" === N || "outside-to-line-or-label" === N) {
            var L = l._private.rscratch, O = L.labelWidth, R = L.labelHeight, V = L.labelX, F = L.labelY, j = O / 2,
                q = R / 2, Y = l.pstyle("text-valign").value;
            "top" === Y ? F -= q : "bottom" === Y && (F += q);
            var X = l.pstyle("text-halign").value;
            "left" === X ? V -= j : "right" === X && (V += j);
            var W = $t(i[0], i[1], [V - j, F - q, V + j, F - q, V + j, F + q, V - j, F + q], c.x, c.y);
            if (W.length > 0) {
                var H = u, K = Ct(H, bt(t)), G = Ct(H, bt(W)), U = K;
                if (G < K && (t = W, U = G), W.length > 2) Ct(H, {x: W[2], y: W[3]}) < U && (t = [W[2], W[3]])
            }
        }
        var Z = Qt(t, n, o.arrowShapes[d].spacing(e) + p), $ = Qt(t, n, o.arrowShapes[d].gap(e) + p);
        if (m.endX = $[0], m.endY = $[1], m.arrowEndX = Z[0], m.arrowEndY = Z[1], "inside-to-node" === _) t = [u.x, u.y]; else if (T.units) t = this.manualEndptToPx(s, T); else if ("outside-to-line" === _) t = m.srcIntn; else if ("outside-to-node" === _ || "outside-to-node-or-label" === _ ? a = r : "outside-to-line" !== _ && "outside-to-line-or-label" !== _ || (a = [c.x, c.y]), t = o.nodeShapes[this.getNodeShape(s)].intersectLine(u.x, u.y, s.outerWidth(), s.outerHeight(), a[0], a[1], 0, M, g), "outside-to-node-or-label" === _ || "outside-to-line-or-label" === _) {
            var Q = s._private.rscratch, J = Q.labelWidth, ee = Q.labelHeight, te = Q.labelX, ne = Q.labelY, re = J / 2,
                ie = ee / 2, ae = s.pstyle("text-valign").value;
            "top" === ae ? ne -= ie : "bottom" === ae && (ne += ie);
            var oe = s.pstyle("text-halign").value;
            "left" === oe ? te -= re : "right" === oe && (te += re);
            var se = $t(a[0], a[1], [te - re, ne - ie, te + re, ne - ie, te + re, ne + ie, te - re, ne + ie], u.x, u.y);
            if (se.length > 0) {
                var le = c, ue = Ct(le, bt(t)), ce = Ct(le, bt(se)), de = ue;
                if (ce < ue && (t = [se[0], se[1]], de = ce), se.length > 2) Ct(le, {
                    x: se[2],
                    y: se[3]
                }) < de && (t = [se[2], se[3]])
            }
        }
        var he = Qt(t, r, o.arrowShapes[h].spacing(e) + f), pe = Qt(t, r, o.arrowShapes[h].gap(e) + f);
        m.startX = pe[0], m.startY = pe[1], m.arrowStartX = he[0], m.arrowStartY = he[1], P && (x(m.startX) && x(m.startY) && x(m.endX) && x(m.endY) ? m.badLine = !1 : m.badLine = !0)
...
au.recalculateEdgeLabelProjections = function (e) {
                ...
                switch (r.edgeType) {
                    ...
                    case"multibezier":
                        for (var d, h = function e() {
                            ...
                            function d(e, t, n, r, i) {
                                var a = kt(t, n), o = e.segments[e.segments.length - 1], s = {
                                    p0: t,
                                    p1: n,
                                    t0: r,
                                    t1: i,
                        ...
                        C = Tt(0, C, 1), t = Dt(x.p0, x.p1, x.p2, C), l = function (e, t, n, r) {
                            var i = Tt(0, r - .001, 1), a = Tt(0, r + .001, 1), o = Dt(e, t, n, i), s = Dt(e, t, n, a);
                            return su(o, s)
                        }(x.p0, x.p1, x.p2, C);
                        break;
                    case"straight":
                    ...
                    case"haystack":
                        for (var S, P, D, T, _ = 0, M = r.allpts.length, B = 0; B + 3 < M && (u ? (D = {
                            x: r.allpts[B],
                            y: r.allpts[B + 1]
                        }, T = {x: r.allpts[B + 2], y: r.allpts[B + 3]}) : (D = {
                            x: r.allpts[M - 2 - B],
                            y: r.allpts[M - 1 - B]
                        }, T = {
                            x: r.allpts[M - 4 - B],
                            y: r.allpts[M - 3 - B]
                        }), P = _, !((_ += S = kt(D, T)) >= c)); B += 2) ;
                        var N = (c - P) / S;
                        N = Tt(0, N, 1), t = function (e, t, n, r) {
                            var i = t.x - e.x, a = t.y - e.y, o = kt(e, t), s = i / o, l = a / o;
    ...
    var n = e._private, r = this.getLabelText(e, t), i = this.calculateLabelDimensions(e, r),
        ...
        s = Ue(n.rscratch, "labelWrapCachedLines", t) || [], l = "wrap" !== o ? 1 : Math.max(s.length, 1),
        u = i.height / l, c = u * a, d = i.width, h = i.height + (l - 1) * (a - 1) * u;
    Ze(n.rstyle, "labelWidth", t, d), Ze(n.rscratch, "labelWidth", t, d), Ze(n.rstyle, "labelHeight", t, h), Ze(n.rscratch, "labelHeight", t, h), Ze(n.rscratch, "labelLineHeight", t, c)
}, au.getLabelText = function (e, t) {
    var n = e._private, r = t ? t + "-" : "", i = e.pstyle(r + "label").strValue, a = e.pstyle("text-transform").value,
        o = function (e, r) {
    ...
    if ("wrap" === s) {
        ...
        for (var c = i.split("\n"), d = e.pstyle("text-max-width").pfValue, h = "anywhere" === e.pstyle("text-overflow-wrap").value, p = [], f = /[\s\u200b]+|$/g, g = 0; g < c.length; g++) {
            var v = c[g], y = this.calculateLabelDimensions(e, v).width;
            if (h) {
                var m = v.split("").join("​");
                v = m
            }
            if (y > d) {
                var b, x = "", w = 0, E = l(v.matchAll(f));
                try {
                    for (E.s(); !(b = E.n()).done;) {
                        var k = b.value, C = k[0], S = v.substring(w, k.index);
                        w = k.index + C.length;
                        var P = 0 === x.length ? S : x + S + C;
                        this.calculateLabelDimensions(e, P).width <= d ? x += S + C : (x && p.push(x), x = S + C)
                    }
                } catch (e) {
                    E.e(e)
                } finally {
        ...
        o("labelWrapCachedLines", p), i = o("labelWrapCachedText", p.join("\n")), o("labelWrapKey", u)
    } else if ("ellipsis" === s) {
        var D = e.pstyle("text-max-width").pfValue, T = "", _ = !1;
    ...
    var n = this, r = n.cy.window().document, i = Te(t, e._private.labelDimsKey),
        a = n.labelDimCache || (n.labelDimCache = []), o = a[i];
    if (null != o) return o;
    var s = e.pstyle("font-style").strValue, l = e.pstyle("font-size").pfValue, u = e.pstyle("font-family").strValue,
        c = e.pstyle("font-weight").strValue, d = this.labelCalcCanvas, h = this.labelCalcCanvasContext;
    if (!d) {
        d = this.labelCalcCanvas = r.createElement("canvas"), h = this.labelCalcCanvasContext = d.getContext("2d");
        var p = d.style;
    ...
    for (var f = 0, g = 0, v = t.split("\n"), y = 0; y < v.length; y++) {
        var m = v[y], b = h.measureText(m), x = Math.ceil(b.width), w = l;
        f = Math.max(x, f), g += w
    }
...
lu.getNodeShape = function (e) {
    ...
    if ("cutrectangle" === t && (e.width() < 28 || e.height() < 28)) return uu || (je("The `cutrectangle` node shape can not be used at small sizes so `rectangle` is used instead"), uu = !0), "rectangle";
...
var cu = {
    ...
    updateCachedGrabbedEles: function () {
        ...
        if (e || !this.cachedZSortedEles) {
            ...
            t.sort(Mo), t.interactive = t.filter((function (e) {
...
fu.binder = function (e) {
    ...
    var s = function (t, r, a) {
        ...
        return i && n.supportsPassiveEvents && (o[2] = {
            capture: null != a && a,
            passive: !1,
            once: !1
    ...
    var e = this, t = e.cy.window(), n = function (e) {
        ...
        n.inDragLayer && (t.forEach(o), t.neighborhood().stdFilter((function (e) {
            return !r || e.isEdge()
        })).forEach(o)), n.addToList && t.forEach((function (e) {
            l(e, n)
        })), function (e, t) {
        ...
        if ((null != t.inDragLayer || null != t.addToList) && e.cy().hasCompoundNodes()) {
            ...
            if (!n.same(e)) {
                var r = n.descendants().spawnSelf().merge(n).unmerge(e).unmerge(e.descendants()),
                    i = r.connectedEdges();
                t.inDragLayer && (i.forEach(o), r.forEach(o)), t.addToList && r.forEach((function (e) {
                    l(e, t)
                }))
            }
        }
    ...
    }, f = "undefined" != typeof MutationObserver, g = "undefined" != typeof ResizeObserver;
    f ? (e.removeObserver = new MutationObserver((function (t) {
    ...
    f && (e.styleObserver = new MutationObserver(v), e.styleObserver.observe(e.container, {attributes: !0})), e.registerBinding(t, "resize", v), g && (e.resizeObserver = new ResizeObserver(v), e.resizeObserver.observe(e.container));
    var y = function () {
    ...
    e.registerBinding(e.container, "mousedown", (function (t) {
        if (m(t) && (1 !== e.hoverData.which || 1 === t.which)) {
            ...
            var n = e.cy, i = [t.clientX, t.clientY], a = e.projectIntoViewport(i[0], i[1]), o = e.selection,
                l = e.findNearestElements(a[0], a[1], !0, !1), d = l[0], h = e.dragData.possibleDragElements;
            ...
            if (3 == t.which) {
                ...
                d ? (d.activate(), d.emit(f), e.hoverData.down = d) : n.emit(f), e.hoverData.downTime = (new Date).getTime(), e.hoverData.cxtDragged = !1
            } else if (1 == t.which) {
                if (d && d.activate(), null != d && e.nodeIsGrabbable(d)) {
                    ...
                    if (s(d), d.selected()) {
                        ...
                        u(v, {addToList: h}), d.emit(g("grabon")), v.forEach((function (e) {
                            e.emit(g("grab"))
                        }))
                    } else h = e.dragData.possibleDragElements = n.collection(), c(d, {addToList: h}), d.emit(g("grabon")).emit(g("grab"));
                    e.redrawHint("eles", !0), e.redrawHint("drag", !0)
                }
                e.hoverData.down = d, e.hoverData.downs = l, e.hoverData.downTime = (new Date).getTime(), r(d, ["mousedown", "tapstart", "vmousedown"], t, {
                    x: a[0],
                    y: a[1]
                }), null == d ? (o[4] = 1, e.data.bgActivePosistion = {
                    x: a[0],
                    y: a[1]
                }, e.redrawHint("select", !0), e.redraw()) : d.pannable() && (o[4] = 1), e.hoverData.tapholdCancelled = !1, clearTimeout(e.hoverData.tapholdTimeout), e.hoverData.tapholdTimeout = setTimeout((function () {
    ...
    e.registerBinding([t, k], "mousemove", (function (t) {
        if (e.hoverData.capture || m(t)) {
            ...
            var v, y = e.hoverData.last, b = e.hoverData.down, w = [c[0] - f[2], c[1] - f[3]],
                E = e.dragData.possibleDragElements;
            if (p) {
                var k = l[0] - p[0], C = k * k, S = l[1] - p[1], P = C + S * S;
            ...
            if (3 === e.hoverData.which) {
                ...
                if (b && b.pannable() && b.active() && b.unactivate(), b && b.grabbed() || g == y || (y && r(y, ["mouseout", "tapdragout"], t, {
                    x: c[0],
                    y: c[1]
                }), g && r(g, ["mouseover", "tapdragover"], t, {x: c[0], y: c[1]}), e.hoverData.last = g), b) if (v) {
                    if (o.boxSelectionEnabled() && D) b && b.grabbed() && (d(E), b.emit("freeon"), E.emit("free"), e.dragData.didDrag && (b.emit("dragfreeon"), E.emit("dragfree"))), T(); else if (b && b.grabbed() && e.nodeIsDraggable(b)) {
                        var N = !e.dragData.didDrag;
                        N && e.redrawHint("eles", !0), e.dragData.didDrag = !0, e.hoverData.draggingEles || u(E, {inDragLayer: !0});
                        var z = {x: 0, y: 0};
                        if (x(w[0]) && x(w[1]) && (z.x += w[0], z.y += w[1], N)) {
                            var I = e.hoverData.dragDelta;
                            I && x(I[0]) && x(I[1]) && (z.x += I[0], z.y += I[1])
                        }
                ...
                if (e.hoverData.dragging || !o.boxSelectionEnabled() || !D && o.panningEnabled() && o.userPanningEnabled()) {
                    if (!e.hoverData.selecting && o.panningEnabled() && o.userPanningEnabled()) {
                        a(b, e.hoverData.downs) && (e.hoverData.dragging = !0, e.hoverData.justStartedPan = !0, f[4] = 0, e.data.bgActivePosistion = bt(h), e.redrawHint("select", !0), e.redraw())
                    }
                } else T();
        ...
        if ((1 !== e.hoverData.which || 1 === t.which || !e.hoverData.capture) && e.hoverData.capture) {
            e.hoverData.capture = !1;
            var a = e.cy, o = e.projectIntoViewport(t.clientX, t.clientY), s = e.selection,
                l = e.findNearestElement(o[0], o[1], !0, !1), u = e.dragData.possibleDragElements, c = e.hoverData.down,
                h = i(t);
            if (e.data.bgActivePosistion && (e.redrawHint("select", !0), e.redraw()), e.hoverData.tapholdCancelled = !0, e.data.bgActivePosistion = void 0, c && c.unactivate(), 3 === e.hoverData.which) {
                ...
                if (r(l, ["mouseup", "tapend", "vmouseup"], t, {
                    ...
                    "additive" === a.selectionType() || h || a.$(n).unmerge(g).unselect(), g.emit("box").stdFilter(v).select().emit("boxselect"), e.redraw()
                }
    ...
    var C, S, P, D, T, _, M, B, N, z, I, A, L, O = function (t) {
        if (!e.scrollingPage) {
    ...
    e.registerBinding(e.container, "wheel", O, !0), e.registerBinding(t, "scroll", (function (t) {
    ...
    var R, V, F, j, q, Y, X, W = function (e, t, n, r) {
        return Math.sqrt((n - e) * (n - e) + (r - t) * (r - t))
    }, H = function (e, t, n, r) {
        return (n - e) * (n - e) + (r - t) * (r - t)
    };
    if (e.registerBinding(e.container, "touchstart", R = function (t) {
        if (e.hasTouchStarted = !0, m(t)) {
            ...
            if (t.touches[1]) {
                ...
                N = l[0], z = l[1], I = l[2], A = l[3], C = t.touches[0].clientX - N, S = t.touches[0].clientY - z, P = t.touches[1].clientX - N, D = t.touches[1].clientY - z, L = 0 <= C && C <= I && 0 <= P && P <= I && 0 <= S && S <= A && 0 <= D && D <= A;
                var h = n.pan(), f = n.zoom();
                T = W(C, S, P, D), _ = H(C, S, P, D), B = [((M = [(C + P) / 2, (S + D) / 2])[0] - h.x) / f, (M[1] - h.y) / f];
            ...
            if (t.touches[2]) n.boxSelectionEnabled() && t.preventDefault(); else if (t.touches[1]) ; else if (t.touches[0]) {
                var y = e.findNearestElements(i[0], i[1], !0, !0), b = y[0];
                if (null != b && (b.activate(), e.touchData.start = b, e.touchData.starts = y, e.nodeIsGrabbable(b))) {
                    var x = e.dragData.touchDragEles = n.collection(), w = null;
                    e.redrawHint("eles", !0), e.redrawHint("drag", !0), b.selected() ? (w = n.$((function (t) {
                        return t.selected() && e.nodeIsGrabbable(t)
                    })), u(w, {addToList: x})) : c(b, {addToList: x}), s(b);
                    var E = function (e) {
                        return {originalEvent: t, type: e, position: {x: i[0], y: i[1]}}
                    };
                    b.emit(E("grabon")), w ? w.forEach((function (e) {
                        e.emit(E("grab"))
                    })) : b.emit(E("grab"))
                }
                r(b, ["touchstart", "tapstart", "vmousedown"], t, {
                    x: i[0],
                    y: i[1]
                }), null == b && (e.data.bgActivePosistion = {
                    x: o[0],
                    y: o[1]
            ...
            if (t.touches.length >= 1) {
                for (var k = e.touchData.startPosition = [null, null, null, null, null, null], O = 0; O < i.length; O++) k[O] = a[O] = i[O];
                var R = t.touches[0];
                e.touchData.startGPosition = [R.clientX, R.clientY]
            }
        }
    }, !1), e.registerBinding(t, "touchmove", V = function (t) {
        var n = e.touchData.capture;
        if (n || m(t)) {
            var i = e.selection, o = e.cy, s = e.touchData.now, l = e.touchData.earlier, c = o.zoom();
            if (t.touches[0]) {
            ...
            if (n && t.touches[0] && f) {
                ...
                var y = t.touches[0].clientX - f[0], b = y * y, w = t.touches[0].clientY - f[1];
                p = b + w * w >= e.touchTapThreshold2
            }
            if (n && e.touchData.cxt) {
                t.preventDefault();
                var E = t.touches[0].clientX - N, k = t.touches[0].clientY - z, M = t.touches[1].clientX - N,
                    I = t.touches[1].clientY - z, A = H(E, k, M, I);
                if (A / _ >= 2.25 || A >= 22500) {
            ...
            if (n && e.touchData.cxt) {
            ...
            } else if (n && t.touches[2] && o.boxSelectionEnabled()) t.preventDefault(), e.data.bgActivePosistion = void 0, this.lastThreeTouch = +new Date, e.touchData.selecting || o.emit({
                originalEvent: t,
                type: "boxstart",
                position: {x: s[0], y: s[1]}
                ...
                var j = e.touchData.start,
                    q = (E = t.touches[0].clientX - N, k = t.touches[0].clientY - z, M = t.touches[1].clientX - N, I = t.touches[1].clientY - z, W(E, k, M, I)),
                    Y = q / T;
                if (L) {
                    var X = (E - C + (M - P)) / 2, K = (k - S + (I - D)) / 2, G = o.zoom(), U = G * Y, Z = o.pan(),
                        $ = B[0] * G + Z.x, Q = B[1] * G + Z.y,
                        J = {x: -U / G * ($ - Z.x - X) + $, y: -U / G * (Q - Z.y - K) + Q};
                    if (j && j.active()) {
                        var ee = e.dragData.touchDragEles;
                        d(ee), e.redrawHint("drag", !0), e.redrawHint("eles", !0), j.unactivate().emit("freeon"), ee.emit("free"), e.dragData.didDrag && (j.emit("dragfreeon"), ee.emit("dragfree"))
                    }
                    o.viewport({
                        zoom: U,
                        pan: J,
                        cancelOnFailedZoom: !0
                    }), o.emit("pinchzoom"), T = q, C = E, S = k, P = M, D = I, e.pinching = !0
                }
                if (t.touches[0]) {
                ...
                if (e.hoverData.draggingEles || e.swipePanning || (R = e.findNearestElement(s[0], s[1], !0, !0)), n && null != te && t.preventDefault(), n && null != te && e.nodeIsDraggable(te)) if (p) {
                    ee = e.dragData.touchDragEles;
                    var re = !e.dragData.didDrag;
                    re && u(ee, {inDragLayer: !0}), e.dragData.didDrag = !0;
                    var ie = {x: 0, y: 0};
                    if (x(g[0]) && x(g[1])) if (ie.x += g[0], ie.y += g[1], re) e.redrawHint("eles", !0), (ae = e.touchData.dragDelta) && x(ae[0]) && x(ae[1]) && (ie.x += ae[0], ie.y += ae[1]);
                ...
                if (r(te || R, ["touchmove", "tapdrag", "vmousemove"], t, {
                    ...
                    type: "tapdragover",
                    position: {x: s[0], y: s[1]}
                })), e.touchData.last = R, n) for (V = 0; V < s.length; V++) s[V] && e.touchData.startPosition[V] && p && (e.touchData.singleTouchMoved = !0);
                if (n && (null == te || te.pannable()) && o.panningEnabled() && o.userPanningEnabled()) {
                    a(te, e.touchData.starts) && (t.preventDefault(), e.data.bgActivePosistion || (e.data.bgActivePosistion = bt(e.touchData.startPosition)), e.swipePanning ? (o.panBy({
                        x: g[0] * c,
                        y: g[1] * c
            ...
            n && t.touches.length > 0 && !e.hoverData.draggingEles && !e.swipePanning && null != e.data.bgActivePosistion && (e.data.bgActivePosistion = void 0, e.redrawHint("select", !0), e.redraw())
        }
    }, !1), e.registerBinding(t, "touchcancel", F = function (t) {
        var n = e.touchData.start;
        e.touchData.capture = !1, n && n.unactivate()
    }), e.registerBinding(t, "touchend", j = function (t) {
        ...
        if (e.touchData.capture) {
            ...
            var o, s = e.cy, l = s.zoom(), u = e.touchData.now, c = e.touchData.earlier;
            if (t.touches[0]) {
                var h = e.projectIntoViewport(t.touches[0].clientX, t.touches[0].clientY);
                u[0] = h[0], u[1] = h[1]
            }
            ...
            if (null != i && i.unactivate(), t.touches[2]) e.data.bgActivePosistion = void 0, e.redrawHint("select", !0); else if (t.touches[1]) ; else if (t.touches[0]) ; else if (!t.touches[0]) {
                e.data.bgActivePosistion = void 0, e.redrawHint("select", !0);
                var g = e.dragData.touchDragEles;
                if (null != i) {
                    var v = i._private.grabbed;
                    d(g), e.redrawHint("drag", !0), e.redrawHint("eles", !0), v && (i.emit("freeon"), g.emit("free"), e.dragData.didDrag && (i.emit("dragfreeon"), g.emit("dragfree"))), r(i, ["touchend", "tapend", "vmouseup", "tapdragout"], t, {
                        x: u[0],
                        y: u[1]
                ...
                var m = e.touchData.startPosition[0] - u[0], b = m * m, x = e.touchData.startPosition[1] - u[1],
                    w = (b + x * x) * l * l;
                e.touchData.singleTouchMoved || (i || s.$(":selected").unselect(["tapunselect"]), r(i, ["tap", "vclick"], t, {
                    x: u[0],
                    y: u[1]
                }), q = !1, t.timeStamp - X <= s.multiClickDebounceTime() ? (Y && clearTimeout(Y), q = !0, X = null, r(i, ["dbltap", "vdblclick"], t, {
                    x: u[0],
                    y: u[1]
                })) : (Y = setTimeout((function () {
                    q || r(i, ["onetap", "voneclick"], t, {x: u[0], y: u[1]})
                }), s.multiClickDebounceTime()), X = t.timeStamp)), null != i && !e.dragData.didDrag && i._private.selectable && w < e.touchTapThreshold2 && !e.pinching && ("single" === s.selectionType() ? (s.$(n).unmerge(i).unselect(["tapunselect"]), i.select(["tapselect"])) : i.selected() ? i.unselect(["tapunselect"]) : i.select(["tapselect"]), e.redrawHint("eles", !0)), e.touchData.singleTouchMoved = !0
            }
            for (var E = 0; E < u.length; E++) c[E] = u[E];
            e.dragData.didDrag = !1, 0 === t.touches.length && (e.touchData.dragDelta = [], e.touchData.startPosition = [null, null, null, null, null, null], e.touchData.startGPosition = null, e.touchData.didSelect = !1), t.touches.length < 2 && (1 === t.touches.length && (e.touchData.startGPosition = [t.touches[0].clientX, t.touches[0].clientY]), e.pinching = !1, e.redrawHint("eles", !0), e.redraw())
        }
        ...
        e.registerBinding(e.container, "pointerdown", (function (e) {
            ...
            Q(e) || (e.preventDefault(), function (e) {
...
var gu = {
    generatePolygon: function (e, t) {
        return this.nodeShapes[e] = {
            renderer: this, name: e, points: t, draw: function (e, t, n, r, i, a) {
...
gu.generateEllipse = function () {
    return this.nodeShapes.ellipse = {
        renderer: this, name: "ellipse", draw: function (e, t, n, r, i, a) {
    ...
    return this.nodeShapes[e] = {
        renderer: this, name: e, points: t, getOrCreateCorners: function (e, n, r, i, a, o, s) {
            ...
            for (p = c[v - 1], h = 0; h < v; h++) f = c[h % v], g = c[(h + 1) % v], o[s][h] = Jl(p, f, g, a), p = f, f = g;
            return o[s]
            ...
            return function (e, t, n, r, i, a, o, s, l) {
                var u, c = [], d = new Array(2 * n.length);
                l.forEach((function (n, a) {
                    0 === a ? (d[d.length - 2] = n.startX, d[d.length - 1] = n.startY) : (d[4 * a - 2] = n.startX, d[4 * a - 1] = n.startY), d[4 * a] = n.stopX, d[4 * a + 1] = n.stopY, 0 !== (u = Gt(e, t, r, i, n.cx, n.cy, n.radius)).length && c.push(u[0], u[1])
                }));
                for (var h = 0; h < d.length / 4; h++) 0 !== (u = Zt(e, t, r, i, d[4 * h], d[4 * h + 1], d[4 * h + 2], d[4 * h + 3], !1)).length && c.push(u[0], u[1]);
                if (c.length > 2) {
    ...
    return this.nodeShapes["round-rectangle"] = this.nodeShapes.roundrectangle = {
        ...
        checkPoint: function (e, t, n, r, i, a, o, s) {
            ...
            return !!Xt(e, t, this.points, a, o, r, i - c, [0, -1], n) || (!!Xt(e, t, this.points, a, o, r - c, i, [0, -1], n) || (!!Kt(e, t, c, c, a - l + s, o - u + s, n) || (!!Kt(e, t, c, c, a + l - s, o - u + s, n) || (!!Kt(e, t, c, c, a + l - s, o + u - s, n) || !!Kt(e, t, c, c, a - l + s, o + u - s, n)))))
        }
    }
    ...
    return this.nodeShapes["cut-rectangle"] = this.nodeShapes.cutrectangle = {
        ...
        generateCutTrianglePts: function (e, t, n, r, i) {
            var a = "auto" === i ? this.cornerLength : i, o = t / 2, s = e / 2, l = n - s, u = n + s, c = r - o,
                d = r + o;
            return {
        ...
        checkPoint: function (e, t, n, r, i, a, o, s) {
            ...
            return Yt(e, t, u.topLeft) || Yt(e, t, u.topRight) || Yt(e, t, u.bottomRight) || Yt(e, t, u.bottomLeft)
        }
    }
}, gu.generateBarrel = function () {
    return this.nodeShapes.barrel = {
        renderer: this, name: "barrel", points: Jt(4, 0), draw: function (e, t, n, r, i, a) {
            this.renderer.nodeShapeImpl(this.name, e, t, n, r, i)
        }, intersectLine: function (e, t, n, r, i, a, o, s) {
            var l = this.generateBarrelBezierPts(n + 2 * o, r + 2 * o, e, t), u = function (e) {
                var t = Dt({x: e[0], y: e[1]}, {x: e[2], y: e[3]}, {x: e[4], y: e[5]}, .15),
                    n = Dt({x: e[0], y: e[1]}, {x: e[2], y: e[3]}, {x: e[4], y: e[5]}, .5),
                    r = Dt({x: e[0], y: e[1]}, {x: e[2], y: e[3]}, {x: e[4], y: e[5]}, .85);
            ...
            var i = t / 2, a = e / 2, o = n - a, s = n + a, l = r - i, u = r + i, c = an(e, t), d = c.heightOffset,
            ...
            var l = an(r, i), u = l.heightOffset, c = l.widthOffset;
            ...
            for (var d = this.generateBarrelBezierPts(r, i, a, o), h = function (e, t, n) {
                ...
                var g = d[p[f]], v = h(e, t, g);
                if (null != v) {
                    var y = g[5], m = g[3], b = g[1], x = Pt(y, m, b, v);
    ...
    return this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle = {
        ...
        intersectLine: function (e, t, n, r, i, a, o, s) {
            var l = t - (r / 2 + o), u = Zt(i, a, e, t, e - (n / 2 + o), l, e + (n / 2 + o), l, !1);
        ...
        checkPoint: function (e, t, n, r, i, a, o, s) {
            ...
            return !!Yt(e, t, [a - u, o - c, a - u, o, a + u, o, a + u, o - c]) || (!!Kt(e, t, l, l, a + r / 2 - s, o + i / 2 - s, n) || !!Kt(e, t, l, l, a - r / 2 + s, o + i / 2 - s, n))
        }
    }
}, gu.registerNodeShapes = function () {
    var e = this.nodeShapes = {}, t = this;
    this.generateEllipse(), this.generatePolygon("triangle", Jt(3, 0)), this.generateRoundPolygon("round-triangle", Jt(3, 0)), this.generatePolygon("rectangle", Jt(4, 0)), e.square = e.rectangle, this.generateRoundRectangle(), this.generateCutRectangle(), this.generateBarrel(), this.generateBottomRoundrectangle();
    var n = [0, 1, 1, 0, 0, -1, -1, 0];
    this.generatePolygon("diamond", n), this.generateRoundPolygon("round-diamond", n), this.generatePolygon("pentagon", Jt(5, 0)), this.generateRoundPolygon("round-pentagon", Jt(5, 0)), this.generatePolygon("hexagon", Jt(6, 0)), this.generateRoundPolygon("round-hexagon", Jt(6, 0)), this.generatePolygon("heptagon", Jt(7, 0)), this.generateRoundPolygon("round-heptagon", Jt(7, 0)), this.generatePolygon("octagon", Jt(8, 0)), this.generateRoundPolygon("round-octagon", Jt(8, 0));
    var r = new Array(20), i = tn(5, 0), a = tn(5, Math.PI / 5), o = .5 * (3 - Math.sqrt(5));
    o *= 1.57;
    for (var s = 0; s < a.length / 2; s++) a[2 * s] *= o, a[2 * s + 1] *= o;
    for (s = 0; s < 5; s++) r[4 * s] = i[2 * s], r[4 * s + 1] = i[2 * s + 1], r[4 * s + 2] = a[2 * s], r[4 * s + 3] = a[2 * s + 1];
    r = en(r), this.generatePolygon("star", r), this.generatePolygon("vee", [-1, -1, 0, -.333, 1, -1, 0, 1]), this.generatePolygon("rhomboid", [-1, -1, .333, -1, 1, 1, -.333, 1]), this.generatePolygon("right-rhomboid", [-.333, -1, 1, -1, .333, 1, -1, 1]), this.nodeShapes.concavehexagon = this.generatePolygon("concave-hexagon", [-1, -.95, -.75, 0, -1, .95, 1, .95, .75, 0, 1, -.95]);
...
bu.clientFunctions = ["redrawHint", "render", "renderTo", "matchCanvasSize", "nodeShapeImpl", "arrowShapeImpl"], bu.init = function (e) {
    var t = this;
    t.options = e, t.cy = e.cy;
    var n = t.container = e.cy.container(), r = t.cy.window();
    if (r) {
        var i = r.document, a = i.head, o = "__________cytoscape_container",
        ...
        "static" === r.getComputedStyle(n).getPropertyValue("position") && je("A Cytoscape container has style position:static and so can not use UI extensions properly")
    }
...
var xu = function (e) {
    return function () {
        ...
        if (!t.dequeueingSetup) {
            ...
            }), e.deqRedrawThreshold), i = e.priority || Re;
            n.beforeRender((function (i, a) {
                var o = we(), s = n.averageRedrawTime, l = n.lastRedrawTime, u = [], c = n.cy.extent(),
                    d = n.getPixelRatio();
                for (i || n.flushRenderedStyleQueue(); ;) {
                    var h = we(), p = h - o, f = h - a;
                    if (l < 1e3 / 60) {
                        var g = 1e3 / 60 - (i ? s : 0);
    ...
    function e(n) {
        ...
        t(this, e), this.idsByKey = new $e, this.keyForId = new $e, this.cachesByLvl = new $e, this.lvls = [], this.getKey = n, this.doesEleInvalidateKey = r
    }
...
}(), Eu = {dequeue: "dequeue", downscale: "downscale", highQuality: "highQuality"}, ku = He({
    getKey: null,
    ...
    var n = ku(t);
    L(this, n), this.lookup = new wu(n.getKey, n.doesEleInvalidateKey), this.setupDequeueing()
}, Su = Cu.prototype;
Su.reasons = Eu, Su.getTextureQueue = function (e) {
    ...
    return this.eleCacheQueue = this.eleCacheQueue || new rt((function (e, t) {
    ...
    if (null == r && (r = Math.ceil(wt(s * n))), r < -4) r = -4; else if (s >= 7.99 || r > 3) return null;
    ...
    }, x = i && i === Eu.dequeue, w = i && i === Eu.highQuality, E = i && i === Eu.downscale, k = r + 1; k <= 3; k++) {
        var C = l.get(e, k);
        if (C) {
            m = C;
            break
    ...
    var S = m && m.level === r + 1 ? m : null, P = function () {
    ...
    e.usedWidth / e.width > .8 && e.fullnessChecks >= 10 ? Ke(t, e) : e.fullnessChecks++
    ...
    for (var n = this.getTextureQueue(e), r = this.getRetiredTextureQueue(e), i = 0; i < r.length; i++) {
        var a = r[i];
        if (a.width >= t) return a.retired = !1, a.usedWidth = 0, a.invalidatedWidth = 0, a.fullnessChecks = 0, Ge(a.eleCaches), a.context.setTransform(1, 0, 0, 1, 0, 0), a.context.clearRect(0, 0, a.width, a.height), Ke(r, a), n.push(a), a
    }
    ...
    null != i && (1 === i.eles.length ? (i.reqs = Ie, t.updateItem(i), t.pop(), n[r] = null) : i.eles.unmerge(e))
...
var Pu = function (e) {
    ...
    t.layersByLevel = {}, t.firstGet = !0, t.lastInvalidationTime = we() - 500, t.skipping = !1, t.eleTxrDeqs = r.collection(), t.scheduleElementRefinement = ve((function () {
...
}, Du = Pu.prototype, Tu = 0, _u = Math.pow(2, 53) - 1;
Du.makeLayer = function (e, t) {
    var n = Math.pow(2, t), r = Math.ceil(e.w * n), i = Math.ceil(e.h * n), a = this.renderer.makeOffscreenCanvas(r, i),
        o = {
            id: Tu = ++Tu % _u,
            bb: e,
            level: t,
    ...
    if (r.firstGet = !1, null == n) if ((n = Math.ceil(wt(i * t))) < -4) n = -4; else if (i >= 3.99 || n > 2) return null;
    ...
    var d = function (t) {
        ...
        var a = Math.ceil(o.w * u), s = Math.ceil(o.h * u);
    ...
    for (var h = null, p = e.length / 1, f = !a, g = 0; g < e.length; g++) {
        ...
        if (b) h = b; else {
            if ((!h || h.eles.length >= p || !Ot(h.bb, v.boundingBox())) && !(h = d({
                insert: !0,
                after: h
            }))) return null;
    ...
    for (var n = k(e[0]), r = 0; r < e.length; r++) for (var i = n ? null : e[r], a = n ? e[r] : e[r].ele, o = a._private.rscratch, s = o.imgLayerCaches = o.imgLayerCaches || {}, l = -4; l <= 2; l++) {
        var u = s[l];
    ...
    var t = this;
    0 !== e.length && (t.lastInvalidationTime = we(), 0 !== e.length && t.haveLayers() && t.updateElementsInLayers(e, (function (e, n, r) {
        t.invalidateLayer(e)
    })))
}, Du.invalidateLayer = function (e) {
    if (this.lastInvalidationTime = we(), !e.invalid) {
        var t = e.level, n = e.eles, r = this.layersByLevel[t];
        Ke(r, e), e.elesQueue = [], e.invalid = !0, e.replacement && (e.replacement.invalid = !0);
...
Ou.drawCachedElement = function (e, t, n, r, i, a) {
    ...
    if (0 !== h.w && 0 !== h.h && t.visible() && (!r || At(h, r))) {
        ...
        o.drawElementUnderlay(e, t), o.drawCachedElementPortion(e, t, l, n, i, p, Ru, qu), f && g || o.drawCachedElementPortion(e, t, u, n, i, p, Vu, Yu), f && !g && (o.drawCachedElementPortion(e, t, c, n, i, p, Fu, Yu), o.drawCachedElementPortion(e, t, d, n, i, p, ju, Yu)), o.drawElementOverlay(e, t)
    }
...
var Xu = {
    drawEdge: function (e, t, n) {
        var r = !(arguments.length > 3 && void 0 !== arguments[3]) || arguments[3],
            ...
            a = !(arguments.length > 5 && void 0 !== arguments[5]) || arguments[5], o = this, s = t._private.rscratch;
        if ((!a || t.visible()) && !s.badLine && null != s.allpts && !isNaN(s.allpts[0])) {
            ...
            var u = a ? t.pstyle("opacity").value : 1, c = a ? t.pstyle("line-opacity").value : 1,
                ...
                f = t.pstyle("line-cap").value, g = t.pstyle("line-outline-width").value,
                v = t.pstyle("line-outline-color").value, y = u * c, m = u * c, b = function () {
                    ...
                    var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : y;
                    e.lineWidth = p + g, e.lineCap = f, g > 0 ? (o.colorStrokeStyle(e, v[0], v[1], v[2], n), "straight-triangle" === d ? o.drawEdgeTrianglePath(t, e, s.allpts) : (o.drawEdgePath(t, e, s.allpts, h), e.lineCap = "butt")) : e.lineCap = "butt"
                }, w = function () {
            ...
            if (S) {
                var P = t.pstyle("ghost-offset-x").pfValue, D = t.pstyle("ghost-offset-y").pfValue,
                    T = t.pstyle("ghost-opacity").value, _ = y * T;
...
Xu.drawEdgeOverlay = Wu("overlay"), Xu.drawEdgeUnderlay = Wu("underlay"), Xu.drawEdgePath = function (e, t, n, r) {
    var i, a = e._private.rscratch, o = t, s = !1, u = this.usePaths(), c = e.pstyle("line-dash-pattern").pfValue,
    ...
    if (!(isNaN(r) || null == r || isNaN(i) || null == i || isNaN(a) || null == a)) {
        ...
        if ("none" !== s) {
            var l = "hollow" === t.pstyle(n + "-arrow-fill").value ? "both" : "filled",
                u = t.pstyle(n + "-arrow-fill").value, c = t.pstyle("width").pfValue, d = t.pstyle(n + "-arrow-width"),
    ...
    var u, c = this, d = this.usePaths() && "triangle-cross" !== i, h = !1, p = t, f = {x: o, y: s},
        g = e.pstyle("arrow-scale").value, v = this.getArrowWidth(r, g), y = c.arrowShapes[i];
    if (d) {
        var m = c.arrowPathCache = c.arrowPathCache || [], b = Te(i), x = m[b];
...
var Hu = {
    safeDrawImage: function (e, t, n, r, i, a, o, s, l, u) {
        ...
        var a = this, o = n.position(), s = o.x, l = o.y, u = n.cy().style(), c = u.getIndexedStyle.bind(u),
            ...
            y = f + ("inner" === c(n, "background-height-relative-to", "value", r) ? 0 : g), m = n._private.rscratch,
            b = "node" === c(n, "background-clip", "value", r), x = c(n, "background-image-opacity", "value", r) * i,
            w = c(n, "background-image-smoothing", "value", r), E = n.pstyle("corner-radius").value;
        "auto" !== E && (E = n.pstyle("corner-radius").pfValue);
        var k = t.width || t.cachedW, C = t.height || t.cachedH;
        ...
        if ("auto" !== c(n, "background-width", "value", r) && (S = "%" === c(n, "background-width", "units", r) ? c(n, "background-width", "pfValue", r) * v : c(n, "background-width", "pfValue", r)), "auto" !== c(n, "background-height", "value", r) && (P = "%" === c(n, "background-height", "units", r) ? c(n, "background-height", "pfValue", r) * y : c(n, "background-height", "pfValue", r)), 0 !== S && 0 !== P) {
            if ("contain" === d) S *= D = Math.min(v / S, y / P), P *= D; else if ("cover" === d) {
                var D;
                S *= D = Math.max(v / S, y / P), P *= D
            }
            var T = s - v / 2, _ = c(n, "background-position-x", "units", r),
                M = c(n, "background-position-x", "pfValue", r);
            T += "%" === _ ? (v - S) * M : M;
            var B = c(n, "background-offset-x", "units", r), N = c(n, "background-offset-x", "pfValue", r);
            T += "%" === B ? (v - S) * N : N;
            var z = l - y / 2, I = c(n, "background-position-y", "units", r),
                A = c(n, "background-position-y", "pfValue", r);
            z += "%" === I ? (y - P) * A : A;
            var L = c(n, "background-offset-y", "units", r), O = c(n, "background-offset-y", "pfValue", r);
            z += "%" === L ? (y - P) * O : O, m.pathCache && (T -= s, z -= l, s = 0, l = 0);
            var R = e.globalAlpha;
            e.globalAlpha = x;
            var V = a.getImgSmoothing(e), F = !1;
            if ("no" === w && V ? (a.setImgSmoothing(e, !1), F = !0) : "yes" !== w || V || (a.setImgSmoothing(e, !0), F = !0), "no-repeat" === h) b && (e.save(), m.pathCache ? e.clip(m.pathCache) : (a.nodeShapes[a.getNodeShape(n)].draw(e, s, l, v, y, E, m), e.clip())), a.safeDrawImage(e, t, 0, 0, k, C, T, z, S, P), b && e.restore(); else {
...
Ku.eleTextBiggerThanMin = function (e, t) {
    if (!t) {
        var n = e.cy().zoom(), r = this.getPixelRatio(), i = Math.ceil(wt(n * r));
        t = Math.pow(2, i)
    }
    ...
    var n = e._private.rscratch, r = t ? t + "-" : "", i = e.pstyle(r + "text-rotation"), a = Ue(n, "labelAngle", t);
    ...
    if (!i || 0 !== s && 0 !== t.pstyle("text-opacity").value) {
        "main" === n && (n = null);
        var l, u, c = Ue(o, "labelX", n), d = Ue(o, "labelY", n), h = this.getLabelText(t, n);
        if (null != h && "" !== h && !isNaN(c) && !isNaN(d)) {
            this.setupTextStyle(e, t, i);
            var p, f = n ? n + "-" : "", g = Ue(o, "labelWidth", n), v = Ue(o, "labelHeight", n),
                y = t.pstyle(f + "text-margin-x").pfValue, m = t.pstyle(f + "text-margin-y").pfValue, b = t.isEdge(),
                x = t.pstyle("text-halign").value, w = t.pstyle("text-valign").value;
            ...
            var E = t.pstyle("text-background-opacity").value, k = t.pstyle("text-border-opacity").value,
                ...
                P = t.pstyle("text-background-shape").strValue, D = 0 === P.indexOf("round"), T = 2;
            if (E > 0 || C > 0 && k > 0) {
                var _ = c - S;
                switch (x) {
                    case"left":
                ...
                var M = d - v - S, B = g + 2 * S, N = v + 2 * S;
                if (E > 0) {
                    var z = e.fillStyle, I = t.pstyle("text-background-color").value;
                    e.fillStyle = "rgba(" + I[0] + "," + I[1] + "," + I[2] + "," + E * s + ")", D ? Gu(e, _, M, B, N, T) : e.fillRect(_, M, B, N), e.fillStyle = z
                }
                if (C > 0 && k > 0) {
                    var A = e.strokeStyle, L = e.lineWidth, O = t.pstyle("text-border-color").value,
                    ...
                    if (D ? Gu(e, _, M, B, N, T, "stroke") : e.strokeRect(_, M, B, N), "double" === R) {
                        var V = C / 2;
                        D ? Gu(e, _ + V, M + V, B - 2 * V, N - 2 * V, T, "stroke") : e.strokeRect(_ + V, M + V, B - 2 * V, N - 2 * V)
                    }
            ...
            if (F > 0 && (e.lineWidth = F), "wrap" === t.pstyle("text-wrap").value) {
                var j = Ue(o, "labelWrapCachedLines", n), q = Ue(o, "labelLineHeight", n), Y = g / 2,
...
var Uu = {
    drawNode: function (e, t, n) {
        ...
        if (x(d.x) && x(d.y) && (!s || t.visible())) {
            ...
            for (var m = t.pstyle("background-image"), b = m.value, w = new Array(b.length), E = new Array(b.length), k = 0, C = 0; C < b.length; C++) {
                var S = b[C], P = w[C] = null != S && "none" !== S;
                if (P) {
            ...
            var T = t.pstyle("background-blacken").value, _ = t.pstyle("border-width").pfValue,
                M = t.pstyle("background-opacity").value * f, B = t.pstyle("border-color").value,
                N = t.pstyle("border-style").value, z = t.pstyle("border-join").value, I = t.pstyle("border-cap").value,
                A = t.pstyle("border-position").value, L = t.pstyle("border-dash-pattern").pfValue,
                O = t.pstyle("border-dash-offset").pfValue, R = t.pstyle("border-opacity").value * f,
                V = t.pstyle("outline-width").pfValue, F = t.pstyle("outline-color").value,
                j = t.pstyle("outline-style").value, q = t.pstyle("outline-opacity").value * f,
                Y = t.pstyle("outline-offset").value, X = t.pstyle("corner-radius").value;
            ...
            var W = function () {
                ...
                var i, a = l.nodePathCache = l.nodePathCache || [],
                    o = _e("polygon" === n ? n + "," + r.join(",") : n, "" + t, "" + e, "" + X), s = a[o], u = !1;
                return null != s ? (i = s, u = !0, c.pathCache = i) : (i = new Path2D, a[o] = c.pathCache = i), {
                    path: i,
                    cacheHit: u
                }
            }, U = t.pstyle("shape").strValue, Z = t.pstyle("shape-polygon-points").pfValue;
            if (g) {
                e.translate(d.x, d.y);
                var $ = G(r, i, U, Z);
                h = $.path, v = $.cacheHit
            ...
            var Q = function () {
                ...
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : f, n = (T > 0 ? T : -T) * t,
                    r = T > 0 ? 0 : 255;
                ...
                if (_ > 0) {
                    ...
                    if ("center" !== A) {
                        if (e.save(), e.lineWidth *= 2, "inside" === A) g ? e.clip(h) : e.clip(); else {
                            var t = new Path2D;
                ...
                if (V > 0) {
                    ...
                    var n = d;
                    g && (n = {x: 0, y: 0});
                    var a = l.getNodeShape(t), o = _;
                    "inside" === A && (o = 0), "outside" === A && (o *= 2);
                    var s, u = (r + o + (V + Y)) / r, c = (i + o + (V + Y)) / i, h = r * u, p = i * c,
                        f = l.nodeShapes[a].points;
                    if (g) s = G(h, p, a, f).path;
                    if ("ellipse" === a) l.drawEllipsePath(s || e, n.x, n.y, h, p); else if (["round-diamond", "round-heptagon", "round-hexagon", "round-octagon", "round-pentagon", "round-polygon", "round-triangle", "round-tag"].includes(a)) {
                        var v = 0, y = 0, m = 0;
            ...
            if (se) {
                var le = t.pstyle("ghost-offset-x").pfValue, ue = t.pstyle("ghost-offset-y").pfValue,
                    ce = t.pstyle("ghost-opacity").value, de = ce * f;
...
Uu.drawNodeOverlay = Zu("overlay"), Uu.drawNodeUnderlay = Zu("underlay"), Uu.hasPie = function (e) {
    ...
    for (var h = 1; h <= i.pieBackgroundN; h++) {
        var p = t.pstyle("pie-" + h + "-background-size").value, f = t.pstyle("pie-" + h + "-background-color").value,
...
$u.getPixelRatio = function () {
    ...
    if ("radial-gradient" === r) if (n.isEdge()) {
        var u = n.sourceEndpoint(), c = n.targetEndpoint(), d = n.midpoint(), h = kt(u, d), p = kt(c, d);
    ...
    var t = (e = e || We()).forcedContext, n = e.drawAllLayers, r = e.drawOnlyNodeLayer, i = e.forcedZoom,
        a = e.forcedPan, o = this, s = void 0 === e.forcedPxRatio ? this.getPixelRatio() : e.forcedPxRatio, l = o.cy,
        u = o.data, c = u.canvasNeedsRedraw,
        d = o.textureOnViewport && !t && (o.pinching || o.hoverData.dragging || o.swipePanning || o.data.wheelZooming),
        h = void 0 !== e.motionBlur ? e.motionBlur : o.motionBlur, p = o.motionBlurPxRatio, f = l.hasCompoundNodes(),
        g = o.hoverData.draggingEles, v = !(!o.hoverData.selecting && !o.touchData.selecting),
    ...
    if (h && 1 !== p) {
        var q = u.contexts[o.NODE], Y = o.data.bufferCanvases[o.MOTIONBLUR_BUFFER_NODE], X = u.contexts[o.DRAG],
...
for (var Qu = {
    drawPolygonPath: function (e, t, n, r, i, a) {
        ...
        var o = r / 2, s = i / 2, l = "auto" === a ? nn(r, i) : Math.min(a, s, o);
        ...
        var o = r / 2, s = i / 2, l = "auto" === a ? nn(r, i) : a;
        ...
        var a = r / 2, o = i / 2, s = t - a, l = t + a, u = n - o, c = n + o, d = an(r, i), h = d.widthOffset,
...
}, Ju = Math.sin(0), ec = Math.cos(0), tc = {}, nc = {}, rc = Math.PI / 40, ic = 0 * Math.PI; ic < 2 * Math.PI; ic += rc) tc[ic] = Math.sin(ic), nc[ic] = Math.cos(ic);
Qu.drawEllipsePath = function (e, t, n, r, i) {
    if (e.beginPath && e.beginPath(), e.ellipse) e.ellipse(t, n, r / 2, i / 2, 0, 0, 2 * Math.PI); else for (var a, o, s = r / 2, l = i / 2, u = 0 * Math.PI; u < 2 * Math.PI; u += rc) a = t - s * tc[u] * Ju + s * nc[u] * ec, o = n + l * nc[u] * Ju + l * tc[u] * ec, 0 === u ? e.moveTo(a, o) : e.lineTo(a, o);
    e.closePath()
};
var ac = {};
...
ac.createBuffer = function (e, t) {
    ...
    var t = this.cy, n = t.mutableElements().boundingBox(), r = this.findContainerClientCoords(),
        i = e.full ? Math.ceil(n.w) : r[2], a = e.full ? Math.ceil(n.h) : r[3], o = x(e.maxWidth) || x(e.maxHeight),
        s = this.getPixelRatio(), l = 1;
    if (void 0 !== e.scale) i *= e.scale, a *= e.scale, l = e.scale; else if (o) {
        var u = 1 / 0, c = 1 / 0;
        x(e.maxWidth) && (u = l * e.maxWidth / i), x(e.maxHeight) && (c = l * e.maxHeight / a), i *= l = Math.min(u, c), a *= l
    }
    o || (i *= s, a *= s, l *= s);
...
function dc(e) {
    ...
    t.data.canvasContainer.style["-webkit-tap-highlight-color"] = "rgba(0,0,0,0)", r.position = "relative", r.zIndex = "0", r.overflow = "hidden";
    var i = e.cy.container();
    i.appendChild(t.data.canvasContainer), i.style["-webkit-tap-highlight-color"] = "rgba(0,0,0,0)";
    var a = {
    ...
    c && c.userAgent.match(/msie|trident|edge/i) && (a["-ms-touch-action"] = "none", a["touch-action"] = "none");
    for (var o = 0; o < cc.CANVAS_LAYERS; o++) {
        var s = t.data.canvases[o] = n.createElement("canvas");
        t.data.contexts[o] = s.getContext("2d"), Object.keys(a).forEach((function (e) {
            s.style[e] = a[e]
        })), s.style.position = "absolute", s.setAttribute("data-id", "layer" + o), s.style.zIndex = String(cc.CANVAS_LAYERS - o), t.data.canvasContainer.appendChild(s), t.data.canvasNeedsRedraw[o] = !1
    }
    t.data.topCanvas = t.data.canvases[0], t.data.canvases[cc.NODE].setAttribute("data-id", "layer" + cc.NODE + "-node"), t.data.canvases[cc.SELECT_BOX].setAttribute("data-id", "layer" + cc.SELECT_BOX + "-selectbox"), t.data.canvases[cc.DRAG].setAttribute("data-id", "layer" + cc.DRAG + "-drag");
    for (o = 0; o < cc.BUFFER_COUNT; o++) t.data.bufferCanvases[o] = n.createElement("canvas"), t.data.bufferContexts[o] = t.data.bufferCanvases[o].getContext("2d"), t.data.bufferCanvases[o].style.position = "absolute", t.data.bufferCanvases[o].setAttribute("data-id", "buffer" + o), t.data.bufferCanvases[o].style.zIndex = String(-o - 1), t.data.bufferCanvases[o].style.visibility = "hidden";
    t.pathsEnabled = !0;
    var l = _t(), u = function (e) {
        ...
        }, getBoundingBox: f, getRotationPoint: function (e) {
    ...
    t.onUpdateEleCalcs((function (e, t) {
        m.invalidateElements(t), b.invalidateElements(t), x.invalidateElements(t), w.invalidateElements(t), E.invalidateElements(t);
        for (var n = 0; n < t.length; n++) {
            var r = t[n]._private;
...
cc.CANVAS_LAYERS = 3, cc.SELECT_BOX = 0, cc.DRAG = 1, cc.NODE = 2, cc.BUFFER_COUNT = 3, cc.TEXTURE_BUFFER = 0, cc.MOTIONBLUR_BUFFER_NODE = 1, cc.MOTIONBLUR_BUFFER_DRAG = 2, cc.redrawHint = function (e, t) {
    var n = this;
    switch (e) {
        case"eles":
...
cc.path2dEnabled = function (e) {
    ...
    var r;
    "undefined" !== ("undefined" == typeof OffscreenCanvas ? "undefined" : e(OffscreenCanvas)) ? r = new OffscreenCanvas(t, n) : ((r = this.cy.window().document.createElement("canvas")).width = t, r.height = n);
    return r
}, [Bu, Ou, Xu, Hu, Ku, Uu, $u, Qu, ac, lc].forEach((function (e) {
    L(cc, e)
}));
var pc = [{type: "layout", extensions: Cl}, {
    type: "renderer",
    extensions: [{name: "null", impl: Sl}, {name: "base", impl: mu}, {name: "canvas", impl: uc}]
}], fc = {}, gc = {};

function vc(e, t, n) {
    var r = n, i = function (n) {
        je("Can not register `" + t + "` for `" + e + "` since `" + n + "` already exists in the prototype and can not be overridden")
    };
    if ("core" === e) {
        ...
        for (var a = function (e) {
            this.options = e, n.call(this, e), b(this._private) || (this._private = {}), this._private.cy = e.cy, this._private.listeners = [], this.createEmitter()
        ...
        }), Fi.eventAliasesOn(o), r = a
    } else if ("renderer" === e && "null" !== t && "base" !== t) {
        var p = yc("renderer", "base"), f = p.prototype, g = n, v = n.prototype, y = function () {
    ...
    } else if ("__proto__" === e || "constructor" === e || "prototype" === e) return Ve(e + " is an illegal type to be registered, possibly lead to prototype pollutions");
...
var xc = function () {
    return 2 === arguments.length ? yc.apply(null, arguments) : 3 === arguments.length ? vc.apply(null, arguments) : 4 === arguments.length ? bc.apply(null, arguments) : 5 === arguments.length ? mc.apply(null, arguments) : void Ve("Invalid extension access syntax")
};
Os.prototype.extension = xc, pc.forEach((function (e) {
...
Ec.instanceString = function () {
    ...
    var n = this.length - 1;
    if (v(e)) this[n].properties.push({
        name: e,
        value: t
    }); else if (b(e)) for (var r = e, i = Object.keys(r), a = 0; a < i.length; a++) {
        var o = i[a], s = r[o];
        if (null != s) {
    ...
    return this
}, Ec.style = Ec.css, Ec.generateStyle = function (e) {
    var t = new Ns(e);
...
var kc = function (e) {
    return void 0 === e && (e = {}), b(e) ? new Os(e) : v(e) ? xc.apply(xc, arguments) : void 0
};
kc.use = function (e) {
    ...
    return Fe(e)
}, kc.version = "snapshot", kc.stylesheet = kc.Stylesheet = wc;
